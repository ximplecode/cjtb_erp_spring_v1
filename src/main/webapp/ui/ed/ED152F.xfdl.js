(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Edit("edt_name","117","145","11.72%","40",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_enable("false");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btn_book","medt_juminNo:2","145","7.81%","40",null,null,null,null,null,null,this);
            obj.set_taborder("40");
            obj.set_text("도서코드");
            obj.set_font("normal bold 10pt/normal \"Arial\"");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_bookCode","btn_book:1","145","10.16%","40",null,null,null,null,null,null,this);
            obj.set_taborder("14");
            ...
            obj = new MaskEdit("medt_taxRate","st_taxRate:2","145","7.89%","40",null,null,null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_format("#.###");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("edt_workRange","Static00_14_00_00:2","187","14.06%","40",null,null,null,null,null,null,this);
            obj.set_taborder("19");
            obj.set_enable("false");
            ...
            obj = new Static("st_SCDtl_contractAmount","edt_workRange:2","187","7.66%","40",null,null,null,null,null,null,this);
            obj.set_text("수량");
            obj.set_background("#ffffff");
            obj.set_color("#10aea9");
            obj.set_font("bold 9pt/normal \"Arial\"");
            ...
            obj = new MaskEdit("medt_unitCost","Static00_10:2","187","7.73%","40",null,null,null,null,null,null,this);
            obj.set_taborder("21");
            obj.set_format("#,#");
            obj.set_enable("false");
            this.addChild(obj.name, obj);
            ...
            obj = new MaskEdit("medt_amount00","Static00_11_00:2","187","8.28%","40",null,null,null,null,null,null,this);
            obj.set_taborder("22");
            obj.set_format("#,#");
            obj.set_enable("false");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("edt_ref","Static00_09:1","372","42.34%","40",null,null,null,null,null,null,this);
            obj.set_taborder("29");
            this.addChild(obj.name, obj);

            obj = new TextArea("txa_remark","Static00_14:1","273","42.34%","97",null,null,null,null,null,null,this);
            obj.set_taborder("28");
            this.addChild(obj.name, obj);

            obj = new Static("Static00_15","txa_remark:3","273","7.73%","70",null,null,null,null,null,null,this);
            obj.set_taborder("49");
            obj.set_text("첨부파일");
            obj.set_background("#ffffff");
            obj.set_color("#10aea9");
            ...
            obj = new Button("btn_cham","edt_ref:2","345","7.73%","70",null,null,null,null,null,null,this);
            obj.set_taborder("52");
            obj.set_text("참조문서");
            obj.set_font("normal bold 10pt/normal \"Arial\"");
            this.addChild(obj.name, obj);
            ...
            obj = new BindItem("item4","edt_name","value","dsOutOrdDtl","OUTER_NAME");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","medt_juminNo","value","dsOutOrdDtl","ATHR_JUMINNO2");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item6","edt_bookCode","value","dsOutOrdDtl","BOOKMST_CODE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item7","edt_bookYear","value","dsOutOrdDtl","BOOKMST_YEAR");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item8","edt_bookName","value","dsOutOrdDtl","OUTORDDTL_BOOKMSTNAME");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item11","cb_section","value","dsOutOrdMst","SECTION_CODE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item12","cb_mnScript","value","dsOutOrdDtl","MNSCRIPT_CODE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item13","chk_permite","value","dsOutOrdMst","OUTORDMST_PERMITE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item14","cal_receipDate","value","dsOutOrdMst","OUTORDMST_RECEIPTDATE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item15","cal_acntDate","value","dsOutOrdDtl","OUTORDDTL_ACNTDATE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item17","medt_taxRate","value","dsOutOrdDtl","OUTORDDTL_TAXRATE");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item25","edt_workRange","value","dsOutOrdDtl","OUTORDDTL_RANGE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item9","medt_tone","value","dsOutOrdDtl","OUTORDDTL_TONE");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item26","medt_qty","value","dsOutOrdDtl","OUTORDDTL_QTY");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item27","medt_unitCost","value","dsOutOrdDtl","OUTORDDTL_UNITCOST");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item10","medt_amount00","value","dsOutOrdDtl","OUTORDDTL_AMOUNT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","txa_remark","value","dsOutOrdMst","OUTORDMST_REMARK");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item18","edt_workContent","value","dsOutOrdDtl","OUTORDDTL_WORKCONTENT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("ED152F.xfdl","Lib::Lib_service.xjs");
        this.addIncludeScript("ED152F.xfdl","Lib::Lib_etc.xjs");
        this.addIncludeScript("ED152F.xfdl","Lib::Lib_gw.xjs");
        this.registerScript("ED152F.xfdl", function() {
        ...
        this.ED152F_onload = function(obj,e)
        {
        	this.setTimer(0,1);

        	var nRow = nexacro.getApplication().gds_menu.findRow("MN_ID", "ed_04_102");
        ...
        this.dsOutOrdMst_onrowsetchanged = function(obj,e)
        {
        	...
        	if(e.reason == 12 ) //dataset이 추가되었을 때
        	{
        		...
        		obj.setColumn(e.row, "OUTORDMST_CLASS", "P1");
        		...
        		obj.setColumn(e.row, "OUTORDMST_PAYKIND", "0");
        ...
        this.Div00_btn_search_onclick = function(obj,e)
        {
        	var objParam = {pdsOutOrdMst:this.dsOutOrdMst,
        					...
        					pOutOrderKind : "P",
        					pOutOrderEtc : "1"}; //popup 화면으로 전달할 값
        ...
        this.ED152F_onsize = function(obj,e)
        {
        	this.setTimer(0,1);
        };

        this.ED152F_ontimer = function(obj,e)
        {
        	var l;
        ...
        {
            this.addEventHandler("onload",this.ED152F_onload,this);
            this.addEventHandler("onsize",this.ED152F_onsize,this);
            this.addEventHandler("ontimer",this.ED152F_ontimer,this);
        ...
        this.loadIncludeScript("ED152F.xfdl");
