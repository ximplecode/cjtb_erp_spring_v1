(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("인쇄비명세서_매엽/윤전");
        ...
        // User Script
        this.addIncludeScript("MK143_1.xfdl","Lib::Lib_etc.xjs");
        this.registerScript("MK143_1.xfdl", function() {
        ...
        this.loadIncludeScript("MK143_1.xfdl");
