(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"NAME\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CODE\">1</Col><Col id=\"NAME\">A4</Col></Row><Row><Col id=\"CODE\">2</Col><Col id=\"NAME\">136컬럼</Col></Row><Row><Col id=\"CODE\">3</Col><Col id=\"NAME\">용지구분</Col></Row><Row><Col id=\"CODE\">4</Col><Col id=\"NAME\">A4세로</Col></Row><Row><Col id=\"CODE\">5</Col><Col id=\"NAME\">현금단가</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsGubun2", this);
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"NAME\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CODE\">1</Col><Col id=\"NAME\">매엽,윤전 구분</Col></Row><Row><Col id=\"CODE\">2</Col><Col id=\"NAME\">국전,4*6 구분</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Radio("rdGubun2",null,"56","250","35","btnSearch:14",null,null,null,null,null,this);
            obj.set_taborder("10");
            ...
            obj = new Static("stKind",null,"56","85","35","rdGubun2:3",null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_text("구분");
            ...
            obj = new Combo("cbCustNm",null,"55","232","35","stKind:8",null,null,null,null,null,this);
            obj.set_taborder("4");
            ...
            obj = new CheckBox("cbEtcCost",null,"19","53","36","btnSearch:34",null,null,null,null,null,this);
            obj.set_taborder("18");
            obj.set_text("포함");
            ...
            obj = new Static("stEtcCost",null,"18","85","35","cbEtcCost:10",null,null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_text("기타외주비");
            obj.set_background("lightsteelblue");
            obj.set_textAlign("center");
            ...
            obj = new CheckBox("cbCtp",null,"19","53","36","stEtcCost:22",null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_text("CTP");
            obj.set_font("bold 16px/normal \"함초롬바탕 확장\"");
            obj.set_truevalue("1");
            ...
            obj = new Static("stCtp",null,"18","85","35","cbCtp:10",null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("CTP 체크");
            obj.set_background("lightsteelblue");
            obj.set_textAlign("center");
            ...
            obj = new Calendar("calEDate",null,"18","160","35","stCtp:8",null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Radio("rdGubun",null,"93","323","66","stKind:8",null,null,null,null,null,this);
            obj.set_taborder("5");
            ...
            obj = new BindItem("item1","cbCtp","value","dsOrdDtl","ORDDTL_CTP");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("MK143.xfdl","Lib::Lib_service.xjs");
        this.addIncludeScript("MK143.xfdl","Lib::Lib_etc.xjs");
        this.addIncludeScript("MK143.xfdl","Lib::Lib_mk.xjs");
        this.registerScript("MK143.xfdl", function() {
        ...
        this.MkMain_onload = function(obj,e)
        {
        	...
        	if(vPerSel = "1"){
        		...
        		this.DivGrd.set_url("mk::MK143_1.xfdl");
        ...
        this.btnSearch_onclick = function(obj,e)
        {
        	...
        	if(this.cbCtp.value == 1)
        	{
        		str_arg = "SDATE=" + nexacro.wrapQuote(this.calSDate.value) + " EDATE=" +nexacro.wrapQuote(this.calEDate.value);
        		this.gfn_TransactionP("update", "JSP/mk/mk143f_ctpcalculater.jsp", "", "", str_arg, "fnCallbackCtp", false, "S", false, this);
        	}


        	if(this.rdGubun.value == 1 && this.rdGubun2.value == 1 || this.rdGubun.value == 4 && this.rdGubun2.value == 1){
        		str_url = "JSP/mk/mk143_Select.jsp";
        	}else if(this.rdGubun.value == 1 && this.rdGubun2.value == 2 || this.rdGubun.value == 4 && this.rdGubun2.value == 2){
        		str_url = "JSP/mk/mk143_Select_Paper.jsp";
        	}else if(this.rdGubun.value == 2  && this.rdGubun2.value == 1){
        		str_url = "JSP/mk/mk143_Select.jsp";
        	}else if(this.rdGubun.value == 2  && this.rdGubun2.value == 2){
        		str_url = "JSP/mk/mk143_Select_Paper.jsp";
        	}else if(this.rdGubun.value == 3  && this.rdGubun2.value == 1){
        		str_url = "JSP/mk/mk143_Select_PprUnit.jsp";
        	}else if(this.rdGubun.value == 3  && this.rdGubun2.value == 2){
        		str_url = "JSP/mk/mk143_Select_PprUnit_Paper.jsp";
        	}else if(this.rdGubun.value == 5  && this.rdGubun2.value == 1){
        		str_url = "JSP/mk/mk143_Unit.jsp";
        	}else if(this.rdGubun.value == 5  && this.rdGubun2.value == 2){
        		str_url = "JSP/mk/mk143_Unit_Paper.jsp";
        	}
        ...
        this.fnCallbackCtp = function(sTrid, nErrorCode, sErrorMsg)
        {
        	if (nErrorCode != 0)
        	{
        ...
        this.fnCallbackSelect = function(sTrid, nErrorCode, sErrorMsg)
        {
        	if (nErrorCode != 0)
        	{
        		...
        		if(this.rdGubun.value == 1 && this.rdGubun2.value == 1 || this.rdGubun.value == 4 && this.rdGubun2.value == 1){
        			...
        			this.dsList1.set_keystring("G:BOOKMSTTYPE,BOOKMSTTYPE_PPRUNIT");
        		}else if(this.rdGubun.value == 1 && this.rdGubun2.value == 2 || this.rdGubun.value == 4 && this.rdGubun2.value == 2){

        			this.dsList1.set_keystring("G:-PPR_STND_NAME,BOOKMSTTYPE");
        		}else if(this.rdGubun.value == 2  && this.rdGubun2.value == 1)
        		{
        			this.dsList1.set_keystring("G:BOOKMSTTYPE,BOOKMSTTYPE_PPRUNIT");
        		}else if(this.rdGubun.value == 2  && this.rdGubun2.value == 2)
        		...
        		}else if(this.rdGubun.value == 3  && this.rdGubun2.value == 1)
        		{
        			...
        			this.dsList1.set_keystring("G:BOOKMSTTYPE_PPRUNIT");
        		}else if(this.rdGubun.value == 5  && this.rdGubun2.value == 2){
        			this.dsList1.set_keystring("G:-PPR_STND_NAME,BOOKMSTTYPE");
        		}
        	}
        ...
        this.btnPrt_onclick = function(obj,e)
        {
        	...
        	if(this.rdGubun.value == 1 && this.rdGubun2.value == 1){
        		rdUrl = gv_svcUrl + "rpt/mk/MK143.mrd";
        	}else if(this.rdGubun.value == 1 && this.rdGubun2.value == 2){
        		rdUrl = gv_svcUrl + "rpt/mk/MK143_PAPER.mrd";
        	}else if(this.rdGubun.value == 2  && this.rdGubun2.value == 1){
        		rdUrl = gv_svcUrl + "rpt/mk/MK143_136.mrd";
        	}else if(this.rdGubun.value == 2  && this.rdGubun2.value == 2){
        		rdUrl = gv_svcUrl + "rpt/mk/MK143_136_PAPER.mrd";
        	}else if(this.rdGubun.value == 3  && this.rdGubun2.value == 1){
        		rdUrl = gv_svcUrl + "rpt/mk/MK143_PPRUNIT.mrd";
        	}else if(this.rdGubun.value == 3  && this.rdGubun2.value == 2){
        		rdUrl = gv_svcUrl + "rpt/mk/MK143_PPRUNIT_PAPER.mrd";
        	}else if(this.rdGubun.value == 4  && this.rdGubun2.value == 1){
        		rdUrl = gv_svcUrl + "rpt/mk/MK143_A4.mrd";
        	}else if(this.rdGubun.value == 4  && this.rdGubun2.value == 2){
        		rdUrl = gv_svcUrl + "rpt/mk/MK143_A4_PAPER.mrd";
        	}else if(this.rdGubun.value == 5  && this.rdGubun2.value == 1){
        		rdUrl = gv_svcUrl + "rpt/mk/MK143_UNIT.mrd";
        	}else if(this.rdGubun.value == 5  && this.rdGubun2.value == 2){
        		rdUrl = gv_svcUrl + "rpt/mk/MK143_UNIT_PAPER.mrd";
        	}
        ...
        {
        	if(e.postvalue == 1 && this.rdGubun2.value == 1 || e.postvalue == 4 && this.rdGubun2.value == 1
        	   || e.postvalue == 2 && this.rdGubun2.value == 1){
        	...
        	}else if(e.postvalue == 1 && this.rdGubun2.value == 2 || e.postvalue == 4 && this.rdGubun2.value == 2
        	   || e.postvalue == 2 && this.rdGubun2.value == 2){
        		this.dsList1.clearData();
        		this.DivGrd.set_url("mk::MK143_1_PAPER.xfdl");
        		this.calSDate.setFocus();
        		this.DivGrd.form.fnChk(this.rdGubun.value);
        	}else if(e.postvalue == 3 && this.rdGubun2.value == 1){

        		this.dsList1.clearData();
        		this.DivGrd.set_url("mk::MK143_2_PPRUNIT.xfdl");
        		this.calSDate.setFocus();

        	}else if(e.postvalue == 3 && this.rdGubun2.value == 2){

        		this.dsList1.clearData();
        		this.DivGrd.set_url("mk::MK143_2_PPRUNIT_PAPER.xfdl");
        		this.calSDate.setFocus();
        	}else if(e.postvalue == 5 && this.rdGubun2.value == 1){

        		this.dsList1.clearData();
        		this.DivGrd.set_url("mk::MK143_1.xfdl");
        		this.DivGrd.form.fnChk(this.rdGubun.value);
        		this.calSDate.setFocus();
        	}else if(e.postvalue == 5 && this.rdGubun2.value == 2){
        ...
        this.rdGubun2_onitemchanged = function(obj,e)
        {
        	if(e.postvalue == 1 && this.rdGubun.value == 1 || e.postvalue == 1 && this.rdGubun.value == 4
        	   || e.postvalue == 1 && this.rdGubun.value == 2){

        		this.dsList1.clearData();
        		this.DivGrd.set_url("mk::MK143_1.xfdl");
        		this.calSDate.setFocus();

        	}else if(e.postvalue == 2 && this.rdGubun.value == 1 || e.postvalue == 2 && this.rdGubun.value == 4
        	   || e.postvalue == 2 && this.rdGubun.value == 2){
        		this.dsList1.clearData();
        		this.DivGrd.set_url("mk::MK143_1_PAPER.xfdl");
        		this.calSDate.setFocus();
        	}else if(e.postvalue == 1 && this.rdGubun.value == 3){

        		this.dsList1.clearData();
        		this.DivGrd.set_url("mk::MK143_2_PPRUNIT.xfdl");
        		this.calSDate.setFocus();
        	}else if(e.postvalue == 2 && this.rdGubun.value == 3){

        		this.dsList1.clearData();
        		this.DivGrd.set_url("mk::MK143_2_PPRUNIT_PAPER.xfdl");
        		this.calSDate.setFocus();
        	}else if(e.postvalue == 1 && this.rdGubun.value == 5){

        		this.dsList1.clearData();
        		this.DivGrd.set_url("mk::MK143_1.xfdl");
        		this.calSDate.setFocus();
        	}else if(e.postvalue == 2 && this.rdGubun.value == 5){
        ...
        this.on_initEvent = function()
        {
            ...
            this.rdGubun2.addEventHandler("onitemchanged",this.rdGubun2_onitemchanged,this);
        ...
        this.loadIncludeScript("MK143.xfdl");
