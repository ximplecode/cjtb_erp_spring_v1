(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new ImageViewer("ImgClose",null,null,"31","30","1.33%","95.18%",null,null,null,null,this);
            obj.set_taborder("1");
        ...
        // User Script
        this.registerScript("MKPRTF.xfdl", function() {
        ...
        this.MKRDF_onload = function(obj,e)
        {
        	...
        	this.WebBrowser00.set_url("https://cj-erp.chunjae.co.kr/erp-next/html/html/ie8/sample_print.html");
        };
        ...
        this.loadIncludeScript("MKPRTF.xfdl");
