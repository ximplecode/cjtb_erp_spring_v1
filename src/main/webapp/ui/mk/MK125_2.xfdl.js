(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("용지입고현황_매입처별");
        ...
        // User Script
        this.addIncludeScript("MK125_2.xfdl","Lib::Lib_etc.xjs");
        this.registerScript("MK125_2.xfdl", function() {
        ...
        this.loadIncludeScript("MK125_2.xfdl");
