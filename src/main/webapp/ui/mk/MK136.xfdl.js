(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Dataset("dsPrintPanQty", this);
            obj._setContents("<ColumnInfo><Column id=\"ORDMST_ID\" type=\"INT\" size=\"20\"/><Column id=\"ORDDTL_SEQ\" type=\"STRING\" size=\"2\"/><Column id=\"BOOKMST_NAME\" type=\"STRING\" size=\"60\"/><Column id=\"PLT_NAME\" type=\"STRING\" size=\"15\"/><Column id=\"ORDMST_DATE\" type=\"STRING\" size=\"8\"/><Column id=\"ORDMST_QTY\" type=\"INT\" size=\"6\"/><Column id=\"USE_NAME\" type=\"STRING\" size=\"20\"/><Column id=\"CUST_GUBN\" type=\"STRING\" size=\"2\"/><Column id=\"CUST_CODE\" type=\"STRING\" size=\"4\"/><Column id=\"CUST_NAME\" type=\"STRING\" size=\"35\"/><Column id=\"ORDDTL_PANQTY\" type=\"INT\" size=\"3\"/><Column id=\"ORDDTL_TONE\" type=\"STRING\" size=\"3\"/><Column id=\"ORDDTL_DETAIL\" type=\"STRING\" size=\"20\"/><Column id=\"EMPLOYEE_ID\" type=\"STRING\" size=\"6\"/><Column id=\"ORDDTL_COMMENT\" type=\"STRING\" size=\"30\"/><Column id=\"ORDDTL_RUNDATE\" type=\"STRING\" size=\"8\"/><Column id=\"ORDDTL_CTP\" type=\"STRING\" size=\"1\"/><Column id=\"PPR_CODE\" type=\"STRING\" size=\"4\"/></ColumnInfo>");
            ...
            obj.set_taborder("6");
            obj.set_binddataset("dsPrintPanQty");
            obj.set_autofittype("none");
            obj._setContents("<Formats><Format id=\"grdList\"><Columns><Column size=\"247\"/><Column size=\"132\"/><Column size=\"90\"/><Column size=\"87\"/><Column size=\"90\"/><Column size=\"175\"/><Column size=\"128\"/><Column size=\"67\"/><Column size=\"41\"/><Column size=\"80\"/></Columns><Rows><Row size=\"38\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"도서명\" font=\"bold 12px/normal &quot;함초롬돋움&quot;\"/><Cell col=\"1\" text=\"판형\" font=\"bold 12px/normal &quot;함초롬돋움&quot;\"/><Cell col=\"2\" font=\"bold 12px/normal &quot;함초롬돋움&quot;\" text=\"발주일자\"/><Cell col=\"3\" text=\"부수\" font=\"bold 12px/normal &quot;함초롬돋움&quot;\"/><Cell col=\"4\" text=\"용도\" font=\"bold 12px/normal &quot;함초롬돋움&quot;\"/><Cell col=\"5\" text=\"외주처\" font=\"bold 12px/normal &quot;함초롬돋움&quot;\"/><Cell col=\"6\" text=\"사양\" font=\"bold 12px/normal &quot;함초롬돋움&quot;\"/><Cell col=\"7\" text=\"색도\" font=\"bold 12px/normal &quot;함초롬돋움&quot;\"/><Cell col=\"8\" text=\"CTP\" font=\"bold 12px/normal &quot;함초롬돋움&quot;\"/><Cell col=\"9\" text=\"판수\" font=\"bold 12px/normal &quot;함초롬돋움&quot;\"/></Band><Band id=\"body\"><Cell text=\"bind:BOOKMST_NAME\" displaytype=\"normal\" combodataset=\"ds_mk_UseType\" combocodecol=\"USE_TYPE_CODE\" combodatacol=\"USE_TYPE_NAME\" font=\"normal 12px/normal &quot;함초롬돋움&quot;\" textAlign=\"left\" edittype=\"none\"/><Cell col=\"1\" text=\"bind:PLT_NAME\" font=\"normal 12px/normal &quot;함초롬돋움&quot;\" edittype=\"none\" textAlign=\"center\"/><Cell col=\"2\" text=\"bind:ORDMST_DATE\" font=\"normal 12px/normal &quot;함초롬돋움&quot;\" textAlign=\"center\" edittype=\"none\" maskeditformat=\"@@\" editinputtype=\"normal\" maskedittype=\"string\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd\"/><Cell col=\"3\" text=\"bind:ORDMST_QTY\" font=\"normal 12px/normal &quot;함초롬돋움&quot;\" textAlign=\"right\" edittype=\"none\" editinputtype=\"normal\"/><Cell col=\"4\" text=\"bind:USE_NAME\" font=\"normal 12px/normal &quot;함초롬돋움&quot;\" textAlign=\"left\" edittype=\"none\" editinputtype=\"normal\"/><Cell col=\"5\" text=\"bind:CUST_NAME\" font=\"normal 12px/normal &quot;함초롬돋움&quot;\" textAlign=\"left\" edittype=\"none\" editinputtype=\"normal\"/><Cell col=\"6\" text=\"bind:ORDDTL_DETAIL\" font=\"normal 12px/normal &quot;함초롬돋움&quot;\" textAlign=\"left\" edittype=\"none\" editinputtype=\"normal\"/><Cell col=\"7\" text=\"bind:ORDDTL_TONE\" font=\"normal 12px/normal &quot;함초롬돋움&quot;\" textAlign=\"center\" edittype=\"none\" editinputtype=\"number\" maskeditformat=\"#,##0.00\" displaytype=\"normal\" editautoselect=\"true\"/><Cell col=\"8\" text=\"bind:ORDDTL_CTP\" font=\"normal 12px/normal &quot;함초롬돋움&quot;\" textAlign=\"right\" edittype=\"none\" editinputtype=\"number\" maskeditformat=\"#,##0.00\" displaytype=\"checkboxcontrol\" editautoselect=\"true\"/><Cell col=\"9\" text=\"bind:ORDDTL_PANQTY\" font=\"normal 12px/normal &quot;함초롬돋움&quot;\" textAlign=\"right\" edittype=\"normal\" editinputtype=\"number\" maskeditformat=\"#,##0.00\" displaytype=\"number\" editautoselect=\"true\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("MK136.xfdl","Lib::Lib_service.xjs");
        this.addIncludeScript("MK136.xfdl","Lib::Lib_etc.xjs");
        this.addIncludeScript("MK136.xfdl","Lib::Lib_mk.xjs");
        this.registerScript("MK136.xfdl", function() {
        ...
        this.btnSearch_onclick = function(obj,e)
        {
        	...
        	in_ds 	= "dsPrintPanQty=dsPrintPanQty";
        	out_ds 	= "dsPrintPanQty=dsPrintPanQty";
        	str_url = "JSP/mk/mk136f_printplate_qty.jsp";
        ...
        this.fnCallbackSelect = function(sTrid, nErrorCode, sErrorMsg)
        {
        	if (nErrorCode != 0)
        	{
        		...
        		if(this.dsPrintPanQty.rowcount == 0)
        			alert("조회된 자료가 없습니다.");
        		else{
        			this.dsPrintPanQty.set_rowposition(0);
        			this.grdList.setCellPos(9);  			// 판수 컬럼 인덱스
        ...
        {
        	in_ds = "input=dsPrintPanQty:U";
        	this.gfn_TransactionP("save", "JSP/mk/mk136f_printplate_qty_dml.jsp", in_ds, "", "", "fnSaveCallback", false, "U", false, this);
        };
        ...
        {
        	var nRow = this.dsPrintPanQty.rowposition;

        	if(this.grdList.getCellPos() == 9)		// 판수
        	{
        		this.dsPrintPanQty.setColumn(nRow, "EMPLOYEE_ID", gv_sabun);

        		var sRunDate = this.dsPrintPanQty.getColumn(nRow, "ORDDTL_RUNDATE");
        			...
        			(this.dsMakeClose.getColumn(0, "MKCLS_MODIFY") == "1"))
        		{
        			...
        			if(this.dsPrintPanQty.rowposition == this.dsPrintPanQty.getRowCount()-1){
        				this.dsPrintPanQty.set_rowposition(0);
        				this.grdList.set_binddataset("");
        				alert(sRunDate + "일자 작업이 완료됐습니다.");
        				this.calSDate.setFocus();
        			}else{
        				this.dsPrintPanQty.set_rowposition(this.dsPrintPanQty.rowposition+1);
        				this.grdList.setCellPos(9);			// 판수 컬럼 인덱스 위치
        				this.grdList.showEditor();
        			}
        		}else{
        			alert(sRunDate + "일은 마감되어 수정할 수 없습니다.");

        			if(Eco.isUndefined(iPANQTY) == false){
        				this.dsPrintPanQty.setColumn(nRow, "ORDDTL_PANQTY", iPANQTY);
        			}
        ...
        //  이전자료 임시 저장
        //#######################################################
        this.dsPrintPanQty_cancolumnchange = function(obj,e)
        {
        	if(e.columnid == "ORDDTL_PANQTY")
        		iPANQTY 	= e.oldvalue;
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.dsPrintPanQty.addEventHandler("cancolumnchange",this.dsPrintPanQty_cancolumnchange,this);
        };
        this.loadIncludeScript("MK136.xfdl");
