(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CUST_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"BOOKTYPE\" type=\"STRING\" size=\"256\"/><Column id=\"WORKKIND\" type=\"STRING\" size=\"256\"/><Column id=\"SCO\" type=\"STRING\" size=\"256\"/><Column id=\"BOOKMSTTYPENAME\" type=\"STRING\" size=\"256\"/><Column id=\"WORKTYPE\" type=\"STRING\" size=\"256\"/><Column id=\"ORDMST_DATE\" type=\"STRING\" size=\"256\"/><Column id=\"ORDMST_NO\" type=\"STRING\" size=\"256\"/><Column id=\"ORDDTL_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"ORD_NO\" type=\"STRING\" size=\"256\"/><Column id=\"ORDDTL_RUNDATE\" type=\"STRING\" size=\"256\"/><Column id=\"CUST_GUBN\" type=\"STRING\" size=\"256\"/><Column id=\"CUST_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"CUST\" type=\"STRING\" size=\"256\"/><Column id=\"BOOK_INFO\" type=\"STRING\" size=\"256\"/><Column id=\"BOOKMST_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"BOOKMST_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"BOOKMST_YEAR\" type=\"STRING\" size=\"256\"/><Column id=\"BOOKMST_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"ORDDTL_PAGE\" type=\"STRING\" size=\"256\"/><Column id=\"ORDMST_QTY\" type=\"FLOAT\" size=\"256\" prop=\"SUM\"/><Column id=\"ORDMST_WORKQTY\" type=\"FLOAT\" size=\"256\" prop=\"SUM\"/><Column id=\"ORDDTL_UNITCOST\" type=\"STRING\" size=\"256\"/><Column id=\"ORDDTL_AMOUNT\" type=\"FLOAT\" size=\"256\" prop=\"SUM\"/><Column id=\"ORDDTL_VAT\" type=\"FLOAT\" size=\"256\" prop=\"SUM\"/><Column id=\"USE_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"USE_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"PAGEUSE_SET\" type=\"STRING\" size=\"256\"/><Column id=\"PAGEBOOKTYPE_SET\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"NAME\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CODE\">0</Col><Col id=\"NAME\">일반</Col></Row><Row><Col id=\"CODE\">1</Col><Col id=\"NAME\">용도별 집계</Col></Row><Row><Col id=\"CODE\">2</Col><Col id=\"NAME\">도서구분별 용도 집계</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsList2", this);
            obj._setContents("<ColumnInfo><Column id=\"CUST_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"CUST_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"CUST\" type=\"STRING\" size=\"256\"/><Column id=\"BOOKTYPE\" type=\"STRING\" size=\"256\"/><Column id=\"BOOKMSTTYPENAME\" type=\"STRING\" size=\"256\"/><Column id=\"USE_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"USE_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"ORDMST_QTY\" type=\"FLOAT\" size=\"256\" prop=\"SUM\"/><Column id=\"ORDMST_WORKQTY\" type=\"FLOAT\" size=\"256\" prop=\"SUM\"/><Column id=\"ORDDTL_AMOUNT\" type=\"FLOAT\" size=\"256\" prop=\"SUM\"/><Column id=\"ORDDTL_VAT\" type=\"FLOAT\" size=\"256\" prop=\"SUM\"/><Column id=\"CO\" type=\"FLOAT\" size=\"256\" prop=\"SUM\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Radio("rdGubun2",null,"17","228","73","btnSearch:11",null,null,null,null,null,this);
            obj.set_taborder("14");
            ...
            obj = new Static("stPaper00",null,"17","85","73","rdGubun2:3",null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("출력구분");
            ...
            obj = new Radio("rdGubun",null,"93","323","47","stPaper00:3",null,null,null,null,null,this);
            obj.set_taborder("5");
            ...
            obj = new Static("Static02","12","10","298","65",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("후가공비명세서");
            ...
            obj = new Combo("cbCustNm",null,"55","232","35","stPaper00:3",null,null,null,null,null,this);
            obj.set_taborder("4");
            ...
            obj = new CheckBox("cbEtcCost",null,"99","53","36","562",null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("포함");
            ...
            obj = new Calendar("calEDate",null,"18","160","35","stPaper00:3",null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Div("DivGrd","11","150","98.85%",null,null,"3",null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_text("");
            obj.set_async("false");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("MK146.xfdl","Lib::Lib_service.xjs");
        this.addIncludeScript("MK146.xfdl","Lib::Lib_etc.xjs");
        this.addIncludeScript("MK146.xfdl","Lib::Lib_mk.xjs");
        this.registerScript("MK146.xfdl", function() {
        ...
        this.loadIncludeScript("MK146.xfdl");
