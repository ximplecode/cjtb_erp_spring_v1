(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("용지입고현황_입고일자별");
        ...
        // User Script
        this.addIncludeScript("MK125_1.xfdl","Lib::Lib_etc.xjs");
        this.registerScript("MK125_1.xfdl", function() {
        ...
        this.loadIncludeScript("MK125_1.xfdl");
