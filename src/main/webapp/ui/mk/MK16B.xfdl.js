(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("기간별 도서제조원가 집계표3");
            ...
            obj = new Static("Static02","12","10","568","65",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("기간별 도서제조원가 집계표3");
        ...
        // User Script
        this.addIncludeScript("MK16B.xfdl","Lib::Lib_service.xjs");
        this.addIncludeScript("MK16B.xfdl","Lib::Lib_etc.xjs");
        this.registerScript("MK16B.xfdl", function() {
        ...
        this.loadIncludeScript("MK16B.xfdl");
