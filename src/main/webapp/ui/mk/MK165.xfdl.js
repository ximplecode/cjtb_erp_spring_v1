(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("월간 거래별 제조원가");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CUST_GUBN\" type=\"STRING\" size=\"256\"/><Column id=\"CUST_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"CUST_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"EDITCOST\" type=\"FLOAT\" size=\"512\"/><Column id=\"FIXEDCOST\" type=\"FLOAT\" size=\"512\"/><Column id=\"VARIABLECOST\" type=\"FLOAT\" size=\"512\"/><Column id=\"BINDQTY\" type=\"INT\" size=\"256\"/><Column id=\"BINDCOST\" type=\"FLOAT\" size=\"512\"/><Column id=\"MATERIALCOST\" type=\"FLOAT\" size=\"512\"/><Column id=\"COSTTOT\" type=\"FLOAT\" size=\"512\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsGubun", this);
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"NAME\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CODE\">1</Col><Col id=\"NAME\">월별 제조원가</Col></Row><Row><Col id=\"CODE\">2</Col><Col id=\"NAME\">연 누적 제조원가</Col></Row><Row><Col id=\"CODE\">3</Col><Col id=\"NAME\">월별 제조원가2</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            
            // UI Components Initialize
            obj = new Static("Static02","12","10","558","65",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("월간 거래별 제조원가");
            ...
            obj = new Button("btnDown",null,"32","21","17","btnSearch:288",null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("▼");
            obj.set_background("lightsteelblue");
            obj.set_font("bold 12px/normal \"함초롬바탕 확장\"");
            ...
            obj = new Radio("rdKind",null,"51","420","35","btnSearch:25",null,null,null,null,null,this);
            obj.set_taborder("11");
        ...
        // User Script
        this.addIncludeScript("MK165.xfdl","Lib::Lib_service.xjs");
        this.addIncludeScript("MK165.xfdl","Lib::Lib_etc.xjs");
        this.registerScript("MK165.xfdl", function() {
        ...
        this.btnSearch_onclick = function(obj,e)
        {
        	...
        	if(this.rdKind.value == 1 || this.rdKind.value == 3){
        		vKind = "MON"
        	...
        	if(this.rdKind.value == 2)
        		str_url = "JSP/mk/mk165_Select2.jsp";
        	else
        		str_url = "JSP/mk/mk165_Select.jsp";
        ...
        this.btnPrt_onclick = function(obj,e)
        {
        	...
        	if(this.rdKind.value == 2)
        		rdUrl = gv_svcUrl + "rpt/mk/MK165_2.mrd";
        	else
        		rdUrl = gv_svcUrl + "rpt/mk/MK165.mrd";
        ...
        this.loadIncludeScript("MK165.xfdl");
