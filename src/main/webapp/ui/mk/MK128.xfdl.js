(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("용지매입 거래처원장");
            this.set_scrolltype("none");
            if (Form == this.constructor)
            {
                this._setFormPosition(630,180);
            }
            ...
            obj.set_taborder("0");
            obj.set_text("용지매입 거래처원장");
            obj.set_color("#7fb39d");
            obj.set_font("bold 40px/normal \"함초롬바탕 확장B\"");
            this.addChild(obj.name, obj);

            obj = new Button("btnPrt",null,"83","80","80","2%",null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("인쇄");
            ...
            obj = new Button("btnSearch",null,"83","80","80","btnPrt:11",null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("조회");
            obj.set_font("bold 14px/normal \"함초롬바탕 확장\"");
            obj.set_visible("true");
            ...
            obj = new Calendar("calEDate","264","83","160","35",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Calendar("calSDate",null,"83","161","35","calEDate:3",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_font("12px/normal \"함초롬바탕 확장\"");
            obj.set_autoselect("true");
            ...
            obj = new Static("stDate",null,"83","85","35","calSDate:3",null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("매입일자");
            obj.set_textAlign("center");
            obj.set_font("bold 14px/normal \"함초롬바탕 확장\"");
            ...
            obj = new ImageViewer("ImgClose",null,null,"31","30","3.02%","68.33%",null,null,null,null,this);
            obj.set_taborder("11");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",630,180,this,function(p){});
        ...
        // User Script
        this.addIncludeScript("MK128.xfdl","Lib::Lib_service.xjs");
        this.addIncludeScript("MK128.xfdl","Lib::Lib_etc.xjs");
        this.addIncludeScript("MK128.xfdl","Lib::Lib_mk.xjs");
        this.registerScript("MK128.xfdl", function() {
        ...
        this.btnPrt_onclick = function(obj,e)
        {
        	...
        	rdUrl = gv_svcUrl + "rpt/mk/MK128.mrd";
        ...
        this.loadIncludeScript("MK128.xfdl");
