(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"ORDDTL_RUNDATE\" type=\"STRING\" size=\"256\"/><Column id=\"ORDMST_DATE\" type=\"STRING\" size=\"256\"/><Column id=\"BOOKMST_CODENAME\" type=\"STRING\" size=\"256\"/><Column id=\"PLT_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"ORDMST_QTY\" type=\"STRING\" size=\"256\"/><Column id=\"ORDDTL_DETAIL\" type=\"STRING\" size=\"256\"/><Column id=\"CUST_NAME\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"NAME\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CODE\">1</Col><Col id=\"NAME\">진행일자별 진행현황</Col></Row><Row><Col id=\"CODE\">2</Col><Col id=\"NAME\">발주일자별 진행현황</Col></Row><Row><Col id=\"CODE\">3</Col><Col id=\"NAME\">외주처별 진행현황</Col></Row><Row><Col id=\"CODE\">4</Col><Col id=\"NAME\">외주처별 미진행현황</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsGubun2", this);
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"NAME\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CODE\">1</Col><Col id=\"NAME\">프린피아</Col></Row><Row><Col id=\"CODE\">2</Col><Col id=\"NAME\">프린피아 외</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsList2", this);
            obj._setContents("<ColumnInfo><Column id=\"ORDMST_DATE\" type=\"STRING\" size=\"256\"/><Column id=\"ORDMST_NO\" type=\"STRING\" size=\"256\"/><Column id=\"PLT_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"ORDMST_QTY\" type=\"STRING\" size=\"256\"/><Column id=\"BOOKMST_CODENAME\" type=\"STRING\" size=\"256\"/><Column id=\"USE_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"CUST_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"ORDDTL_RUNDATE\" type=\"STRING\" size=\"256\"/><Column id=\"ORDDTL_TONE\" type=\"STRING\" size=\"256\"/><Column id=\"ORDDTL_JMI\" type=\"STRING\" size=\"256\"/><Column id=\"PPR_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"PPR_UNIT\" type=\"STRING\" size=\"256\"/><Column id=\"ORDDTL_DETAIL\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static02","12","10","228","65",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("진행현황");
            ...
            obj = new Combo("cbCustNm",null,"94","232","35","btnSearch:30",null,null,null,null,null,this);
            obj.set_taborder("4");
            ...
            obj = new Edit("edSCustCd",null,"94","88","35","cbCustNm:3",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_font("12px/normal \"함초롬바탕 확장\"");
            obj.set_maxlength("4");
            obj.set_autoselect("true");
            ...
            obj = new Static("stCust",null,"94","85","35","edSCustCd:3",null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("외주처");
            ...
            obj = new Calendar("calEDate",null,"18","160","35","btnSearch:30",null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Radio("rdGubun",null,"18","280","150","stDate:22",null,null,null,null,null,this);
            obj.set_taborder("5");
            ...
            obj = new Div("DivGrd","11","186","98.85%",null,null,"16",null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Edit("edEBookCd",null,"56","160","35","btnSearch:30",null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_font("12px/normal \"함초롬바탕 확장\"");
            ...
            obj = new Edit("edt_bookCode",null,"56","160","35","edEBookCd:3",null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_font("12px/normal \"함초롬바탕 확장\"");
            obj.set_maxlength("10");
            obj.set_textAlign("center");
            ...
            obj = new Button("btnBook_Search",null,"56","85","35","edt_bookCode:3",null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("도서코드");
            obj.set_font("bold 14px/normal \"함초롬바탕 확장\"");
            this.addChild(obj.name, obj);

            obj = new Radio("rdGubun2",null,"133","411","35","btnSearch:30",null,null,null,null,null,this);
            obj.set_taborder("15");
            ...
            obj.set_background("lightsteelblue");
            obj.set_color("white");
            obj.set_padding("0px 0px 0px 60px");
        ...
        // User Script
        this.addIncludeScript("MK142.xfdl","Lib::Lib_service.xjs");
        this.addIncludeScript("MK142.xfdl","Lib::Lib_etc.xjs");
        this.addIncludeScript("MK142.xfdl","Lib::Lib_mk.xjs");
        this.registerScript("MK142.xfdl", function() {
        ...
        this.MkMain_onload = function(obj,e)
        {
        	...
        	if(vPerSel = "1"){
        		...
        		this.DivGrd.set_url("mk::MK142_1.xfdl");
        ...
        this.btnSearch_onclick = function(obj,e)
        {
        	...
        	if(this.rdGubun.value == 1){
        		str_url = "JSP/mk/mk142_Select1.jsp";
        		in_ds 	= "dsList1=dsList1";
        		out_ds 	= "dsList1=dsList1";
        	}
        	else if(this.rdGubun.value == 2){
        		str_url = "JSP/mk/mk142_Select2.jsp";
        		in_ds 	= "dsList2=dsList2";
        		out_ds 	= "dsList2=dsList2";
        	}else if(this.rdGubun.value == 3){
        		str_url = "JSP/mk/mk142_Select3.jsp";
        		in_ds 	= "dsList2=dsList2";
        		out_ds 	= "dsList2=dsList2";
        	}
        	else{
        		str_url = "JSP/mk/mk142_Select4.jsp";
        		in_ds 	= "dsList2=dsList2";
        		out_ds 	= "dsList2=dsList2";

        		if(this.rdGubun2.value == 1){
        			sCust_Gubn = "41";
        			vCustCd = "1034";
        		}else{
        			sCust_Gubn = "41";
        	...
        	str_arg = "SDATE=" + nexacro.wrapQuote(this.calSDate.value) +
        			  ...
        			  " BOOK_SCODE=" +nexacro.wrapQuote( this.edt_bookCode.value) +
        ...
        this.btnPrt_onclick = function(obj,e)
        {
        	...
        	var rdUrl = gv_svcUrl + "rpt/mk/MK142_"+this.rdGubun.value+".mrd";

        	if(this.rdGubun.value != 4)
        		var rdParam = "/ragentpath ["+ gv_urlRdDataServer +"]"+ " /rp [" + this.calSDate.value + "] [" + this.calEDate.value + "] [" + sCust_Gubn + "] [" +  vCustCd + "] [" +  this.edt_bookCode.value + "] [" +  this.edEBookCd.value + "]";
        	else
        		var rdParam = "/ragentpath ["+ gv_urlRdDataServer +"]"+ " /rp [" + this.rdGubun2.index + "] [" +  this.edt_bookCode.value + "] [" +  this.edEBookCd.value + "]";
        ...
        {
        	if(e.postvalue == 1){
        		this.stDate.set_text("진행일자");
        		this.calSDate.set_enable(true);
        		this.calEDate.set_enable(true);
        		this.DivGrd.set_url("mk::MK142_1.xfdl");
        		this.calSDate.setFocus();

        	}else if(e.postvalue == 2){

        		this.stDate.set_text("발주일자");
        		this.calSDate.set_enable(true);
        		this.calEDate.set_enable(true);
        		this.DivGrd.set_url("mk::MK142_2.xfdl");
        		this.calSDate.setFocus();
        		...
        		this.calSDate.set_enable(true);
        		this.calEDate.set_enable(true);
        		this.DivGrd.set_url("mk::MK142_3.xfdl");
        		this.calSDate.setFocus();
        		...
        		this.calEDate.set_enable(false);
        		this.DivGrd.set_url("mk::MK142_4.xfdl");
        		this.edt_bookCode.setFocus();
        	}

        	this.rdGubun2.set_enable(e.postvalue == 4);
        	this.edSCustCd.set_enable(e.postvalue != 4);
        	this.cbCustNm.set_enable(e.postvalue != 4);
        };
        ...
        this.btnBook_Search_onclick = function(obj,e)
        {
        	...
        	var objParam = {dsParam1:this.dsBookMst
        					,dsParam2:"MK14B"
        					,dsParam3:this.edt_bookCode.value
        ...
        this.loadIncludeScript("MK142.xfdl");
