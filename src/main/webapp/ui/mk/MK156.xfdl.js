(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("MK156.xfdl","Lib::Lib_service.xjs");
        this.addIncludeScript("MK156.xfdl","Lib::Lib_etc.xjs");
        this.registerScript("MK156.xfdl", function() {
        ...
        this.loadIncludeScript("MK156.xfdl");
