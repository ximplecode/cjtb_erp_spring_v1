(function()
{
    return function()
    {
        ...
        {
            this.set_name("SW102F");
            this.set_titletext("New Form");
            if (Form == this.constructor)
            {
                this._setFormPosition(950,770);
            }
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",950,770,this,function(p){});
        ...
        // User Script
        this.addIncludeScript("SW102F.xfdl","Lib::Lib_service.xjs");
        this.addIncludeScript("SW102F.xfdl","Lib::Lib_etc.xjs");
        this.registerScript("SW102F.xfdl", function() {
        this.executeIncludeScript("Lib::Lib_service.xjs"); /*include "Lib::Lib_service.xjs"*/;
        this.executeIncludeScript("Lib::Lib_etc.xjs"); /*include "Lib::Lib_etc.xjs"*/;
        var gv_urlMrd = nexacro.getApplication().gv_urlMrd;
        var gv_svraddr = nexacro.getApplication().gfn_getUrl("svcUrl");
        this.SW102F_onload = function(obj,e)
        {
        	var rdopt, rdfile;
        ...
        {
            this.addEventHandler("onload",this.SW102F_onload,this);
        };
        this.loadIncludeScript("SW102F.xfdl");
