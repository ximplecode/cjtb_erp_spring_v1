(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Dataset("dsBTMst_copy", this);
            ...
            obj = new Static("Static00","20","5","325","40",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("출장복명서 조회");
        ...
        // User Script
        this.addIncludeScript("PD180_SearchF.xfdl","Lib::Lib_service.xjs");
        this.addIncludeScript("PD180_SearchF.xfdl","Lib::Lib_etc.xjs");
        this.registerScript("PD180_SearchF.xfdl", function() {
        ...
        this.btn_search_onclick = function(obj,e)
        {
        	...
        	var strDs = "dsBTMst_copy=dsBTMst_copy";
        	strArg 	= "BTMST_SDATE=" + nexacro.wrapQuote( this.cal_sdate.value ) +
        	          " BTMST_EDATE=" + nexacro.wrapQuote( this.cal_edate.value ) +
        	          " BTMST_PERMITE=" + nexacro.wrapQuote( this.rdo_permite.index ) +
        ...
        this.fnCallback = function(svcid, errCode, errMsg)
        {
        	if(svcid == "search")
        	{
        		...
        		if(errCode != 0)
        			trace("[PD180_SearchF.fnCallBack(" + f_date + ")] " + svcid +"::"+ errMsg );
        		else if (this.dsBTMst_copy.rowcount == 0)
        		{
        			this.dsBTMst_copy.clearData();
        			this.opener.dsBTDtl.clearData();
        			this.opener.dsBTMem.clearData();
        			alert("조회된 자료가 없습니다.");
        		}
        		else
        		{
        			this.opener.dsBTMst.copyData(this.dsBTMst_copy);
        		}
        	}
        }
        ...
        {
            this.addEventHandler("onload",this.PD180_SearchF_onload,this);
        ...
        this.loadIncludeScript("PD180_SearchF.xfdl");
