(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Dataset("dsGovAcntMst_copy", this);
        ...
        // User Script
        this.addIncludeScript("PD170_SearchF.xfdl","Lib::Lib_service.xjs");
        this.addIncludeScript("PD170_SearchF.xfdl","Lib::Lib_etc.xjs");
        this.registerScript("PD170_SearchF.xfdl", function() {
        this.executeIncludeScript("Lib::Lib_service.xjs"); /*include "Lib::Lib_service.xjs"*/;
        this.executeIncludeScript("Lib::Lib_etc.xjs"); /*include "Lib::Lib_etc.xjs"*/;

        var sSection = "";

        this.PD170_SearchF_onload = function(obj,e)
        {
        ...
        {
            this.addEventHandler("onload",this.PD170_SearchF_onload,this);
            ...
            this.dsGovAcntMst_copy.addEventHandler("onload",this.dsGovAcntMst_onload,this);
            this.dsGovAcntMst_copy.addEventHandler("onrowposchanged",this.dsGovAcntMst_onrowposchanged,this);
        };
        this.loadIncludeScript("PD170_SearchF.xfdl");
