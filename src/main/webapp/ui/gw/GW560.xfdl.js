(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"NAME\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CODE\">01</Col><Col id=\"NAME\">일일 주차</Col></Row><Row><Col id=\"CODE\">02</Col><Col id=\"NAME\">정기 주차</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"70\"/><Column size=\"30\"/><Column size=\"100\"/><Column size=\"85\"/><Column size=\"150\"/><Column size=\"80\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"150\"/><Column size=\"30\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell colspan=\"2\" text=\"사용자\"/><Cell col=\"2\" text=\"부서\"/><Cell col=\"3\" text=\"신청종류\"/><Cell col=\"4\" text=\"차량종류\"/><Cell col=\"5\" text=\"차량번호\"/><Cell col=\"6\" colspan=\"2\" text=\"신청기간\"/><Cell col=\"8\" text=\"신청사유\"/><Cell col=\"9\"/></Band><Band id=\"body\"><Cell text=\"bind:NAME\" edittype=\"none\"/><Cell col=\"1\" displaytype=\"buttoncontrol\"/><Cell col=\"2\" text=\"bind:SECTION_CODE\" displaytype=\"combotext\" combodataset=\"dsSection\" combocodecol=\"SECTION_CODE\" combodatacol=\"SECTION_NAME\" edittype=\"none\"/><Cell col=\"3\" text=\"bind:REG_KIND\" edittype=\"combo\" displaytype=\"combocontrol\" combodataset=\"ds_regKind\" combocodecol=\"CODE\" combodatacol=\"NAME\"/><Cell col=\"4\" text=\"bind:CAR_KIND\" edittype=\"normal\"/><Cell col=\"5\" text=\"bind:CAR_NUMBER\" edittype=\"normal\"/><Cell col=\"6\" text=\"bind:REG_S_DATE\" edittype=\"date\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd\" calendardisplaynulltype=\"none\"/><Cell col=\"7\" text=\"bind:REG_E_DATE\" displaytype=\"date\" edittype=\"date\" calendardateformat=\"yyyy-MM-dd\" calendardisplaynulltype=\"none\"/><Cell col=\"8\" text=\"bind:REG_BIGO\" edittype=\"normal\"/><Cell col=\"9\" text=\"삭제\" displaytype=\"buttoncontrol\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        this.GW560_onload = function(obj,e)
        {
        	...
        	else //개인결재라인 가져오기 (개인결재라인 X -> 관리자가 설정해놓은 결재라인 가져옴)
        	{
        		var msg_data =
        					"1) 주차 구분 \n" +
        					"  - 일일 주차 : 업무 상 1일 주차 필요 시. \n" +
        					"  - 정기 주차 : 기준 충족자 한정. 기한 한정 없음. \n" +
        					"                   단, 주차 공간 없을 시 불가. \n" +
        					"  - 정기주차 기준 : 팀장 직책 이상자, 업무 상 잦은 외근 발생자 \n\n" +

        					"2) 결재라인 \n" +
        					"[신청]기안자>[결재]팀장>[합의]인사관리팀 이수재>[결재]본부장 \n\n";
        ...
        this.fn_save = function()
        {
        	...
        	this.ds_flow_header.setColumn(0, "TITLE", nexacro.trim("[주차장 이용 신청서]" + this.ds_mst.getColumn(0, "INSERT_DATE") + " " + this.ds_mst.getColumn(0, "CAR_KIND") + " " + this.ds_mst.getColumn(0, "CAR_NUMBER") + " 외"));
