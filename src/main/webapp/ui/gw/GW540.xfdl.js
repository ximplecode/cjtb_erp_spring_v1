(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"I_FLOW_ID\" type=\"STRING\" size=\"256\"/><Column id=\"SEQNO\" type=\"STRING\" size=\"256\"/><Column id=\"YMD\" type=\"STRING\" size=\"256\"/><Column id=\"SABUN\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"CORP_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"ASSET_ID\" type=\"STRING\" size=\"256\"/><Column id=\"ASSET_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"LOWLEVEL_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"ARM_DATE\" type=\"STRING\" size=\"256\"/><Column id=\"ARM_REPAIR_GB\" type=\"STRING\" size=\"256\"/><Column id=\"ARM_REMARK\" type=\"STRING\" size=\"256\"/><Column id=\"ARM_BIGO\" type=\"STRING\" size=\"256\"/><Column id=\"ARM_REASON\" type=\"STRING\" size=\"256\"/><Column id=\"ARM_CUST_GB\" type=\"STRING\" size=\"256\"/><Column id=\"ARM_CUST_NM\" type=\"STRING\" size=\"256\"/><Column id=\"ARM_TEXT\" type=\"STRING\" size=\"256\"/><Column id=\"ARM_COM_DATE\" type=\"STRING\" size=\"256\"/><Column id=\"ARM_SA_GB\" type=\"STRING\" size=\"256\"/><Column id=\"ARM_AMOUNT\" type=\"STRING\" size=\"256\"/><Column id=\"NAME\" type=\"STRING\" size=\"256\"/><Column id=\"COMMON_ID\" type=\"STRING\" size=\"256\"/><Column id=\"ASSET_SEQ_INPUT\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj._setContents("<ColumnInfo><Column id=\"KIND_CD\" type=\"STRING\" size=\"256\"/><Column id=\"KIND_NM\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"KIND_CD\">01</Col><Col id=\"KIND_NM\">수리</Col></Row><Row><Col id=\"KIND_CD\">02</Col><Col id=\"KIND_NM\">손망실</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("grd_dtl","10","190","788","518",null,null,null,null,null,null,this);
            obj.set_taborder("34");
            obj.set_binddataset("ds_mst");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"150\"/><Column size=\"30\"/><Column size=\"100\"/><Column size=\"70\"/><Column size=\"30\"/><Column size=\"100\"/><Column size=\"200\"/><Column size=\"30\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"신청구분\"/><Cell col=\"1\" colspan=\"2\" text=\"품목명\"/><Cell col=\"3\" text=\"자산번호\"/><Cell col=\"4\" colspan=\"2\" text=\"신청자\"/><Cell col=\"6\" text=\"부서\"/><Cell col=\"7\" text=\"수리사유\"/><Cell col=\"8\"/></Band><Band id=\"body\"><Cell text=\"bind:ARM_REPAIR_GB\" displaytype=\"combocontrol\" edittype=\"combo\" combodataset=\"ds_kind\" combocodecol=\"KIND_CD\" combodatacol=\"KIND_NM\"/><Cell col=\"1\" text=\"bind:LOWLEVEL_NAME\" edittype=\"none\"/><Cell col=\"2\" displaytype=\"buttoncontrol\"/><Cell col=\"3\" text=\"bind:ASSET_SEQ_INPUT\" edittype=\"normal\"/><Cell col=\"4\" text=\"bind:NAME\" edittype=\"none\"/><Cell col=\"5\" displaytype=\"buttoncontrol\"/><Cell col=\"6\" text=\"bind:DEPT_CODE\" displaytype=\"combotext\" combodataset=\"dsSection\" combocodecol=\"SECTION_CODE\" combodatacol=\"SECTION_NAME\" edittype=\"none\"/><Cell col=\"7\" text=\"bind:ARM_REMARK\" edittype=\"normal\"/><Cell col=\"8\" text=\"삭제\" displaytype=\"buttoncontrol\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new BindItem("item5","chk_open","value","ds_flow_header","OPEN_CHECK");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("GW540.xfdl","Lib::Lib_service.xjs");
        this.addIncludeScript("GW540.xfdl","Lib::Lib_etc.xjs");
        this.addIncludeScript("GW540.xfdl","Lib::Lib_gw.xjs");
        this.registerScript("GW540.xfdl", function() {
        ...
        this.GW540_onload = function(obj,e)
        {
        	//GW200 에서 넘겨준 값
        	...
        	if(MD == "1") //수정, 재기안일 경우
        	{
        		...
        		var strUrl = "JSP/gw/SQL_GW540_M_SELECT.jsp";
        ...
        this.btn_delete_onclick = function(obj,e)
        {
        	...
        	{
        		strUrl   = "JSP/gw/SQL_GW540_DELETE.jsp";
        		var strArg = "i_flow_id=" + nexacro.wrapQuote(rt_i_flow_id);
        ...
        this.fn_save = function()
        {
        	...
        	this.ds_flow_header.setColumn(0, "TITLE", nexacro.trim("[자산 수리 신청서]" + gv_buseNm + " " + gv_name));
        ...
        this.fnSaveHeaderCallback = function (svcId, errCode, errMsg, gv_rt_i_flow_id)
        {
        	...
        	else
        	{
        		...
        		this.ds_mst.setColumn(this.ds_mst.rowposition, "DEPT_CODE", gv_buseCd)
        		...
        		strUrl   = "JSP/gw/SQL_GW540_M_DML.jsp";
        		var inds = "ds_mst=ds_mst";
        ...
        {
        	if(e.reason == 12) //insert 될 때
        	{
        		this.ds_mst.setColumn(e.row, "", today.substr(0,8));
        		this.ds_mst.setColumn(e.row, "DEPT_CODE", gv_buseCd);
        		this.ds_mst.setColumn(e.row, "NAME", gv_name);
        		this.ds_mst.setColumn(e.row, "SABUN", gv_sabun);
        	}
        };
        	...
        	switch(e.cell)
        	{
        		...
        		case 8: //삭제
        			...
        			if(this.ds_mst.getColumn(e.row, "SEQNO") == null)
        			{
        				...
        				{
        					var strUrl = "JSP/gw/SQL_GW540_DELETE.jsp";
        ...
        {
            this.addEventHandler("onload",this.GW540_onload,this);
        ...
        this.loadIncludeScript("GW540.xfdl");
