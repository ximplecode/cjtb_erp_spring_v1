(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("SD1040F_GRID2","0.00%","0",null,"100.00%","0.00%",null,null,null,null,null,this);
            obj.set_taborder("0");
        ...
        // User Script
        this.addIncludeScript("SD1040F_GRID2.xfdl","Lib::Lib_etc.xjs");
        this.registerScript("SD1040F_GRID2.xfdl", function() {
        ...
        */
        ...
        this.loadIncludeScript("SD1040F_GRID2.xfdl");
