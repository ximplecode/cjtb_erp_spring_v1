(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"NAME\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CODE\">0</Col><Col id=\"NAME\">코드순</Col></Row><Row><Col id=\"CODE\">1</Col><Col id=\"NAME\">명칭순</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_book_hcode", this);
            ...
            obj = new Dataset("ds_book_hcode_send", this);
            ...
            obj.set_taborder("26");
            obj.set_binddataset("ds_book_hcode");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"30\"/><Column size=\"700\"/><Column size=\"700\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell edittype=\"checkbox\" displaytype=\"checkboxcontrol\"/><Cell col=\"1\" text=\"코드\"/><Cell col=\"2\" text=\"명칭\"/></Band><Band id=\"body\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:CHK\"/><Cell col=\"1\" text=\"bind:CODE\"/><Cell col=\"2\" text=\"bind:NAME\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("SD6190F.xfdl","Lib::Lib_service.xjs");
        this.addIncludeScript("SD6190F.xfdl","Lib::Lib_etc.xjs");
        this.registerScript("SD6190F.xfdl", function() {
        ...
        this.SD6190F_onload = function(obj,e)
        {
        ...
        {
        	var strUrl = "JSP/sd/sd6190b.jsp";
        	var strArg;
        	var strDs 	= "ds_book_hcode=ds_book_hcode";
        ...
        {
        	this.ds_book_hcode.setColumn(NewRowNum,"CODE", nexacro.trim(this.ed_code.value));
        	this.ds_book_hcode.setColumn(NewRowNum,"NAME", this.ed_name.text);
            this.ds_book_hcode_send.addRow();
        	this.ds_book_hcode_send.copyRow(0,this.ds_book_hcode,NewRowNum);
        	this.ds_book_hcode_send.setColumn(0,"O_CODE", o_code);
        	this.ds_book_hcode_send.setColumn(0,"ROWTYPE", "I" );
        }

        //수정모드
        this.fnEdit_data = function()
        {
        	this.ds_book_hcode.setColumn(EditnRow,"CODE", nexacro.trim(this.ed_code.value));
        	this.ds_book_hcode.setColumn(EditnRow,"NAME", this.ed_name.text);
            this.ds_book_hcode_send.addRow();
        	this.ds_book_hcode_send.copyRow(0,this.ds_book_hcode,EditnRow);
        	this.ds_book_hcode_send.setColumn(0,"O_CODE", o_code);
        	this.ds_book_hcode_send.setColumn(0,"ROWTYPE", "U" );
        ...
        {
        	EditnRow = e.row;
        	this.ed_code.set_value(this.ds_book_hcode.getColumn(e.row,"CODE"));
        	o_code       = this.ds_book_hcode.getColumn(e.row,"CODE");
        	this.ed_name.set_value(this.ds_book_hcode.getColumn(e.row,"NAME"));
        };

        this.btn_save_onclick = function(obj,e)
        {
        	var strUrl = "JSP/sd/insert_book_hcode.jsp";
        	var inDs 	= "ds_book_hcode_send=ds_book_hcode_send";
        	...
        	{
        		NewRowNum = this.ds_book_hcode.addRow();
        		this.fnInputdata();
        	}
        ...
        this.fnTr_Callback = function(strSvcID, nErrorCode, strErrorMag)
        {
        	if ( strSvcID == "insert" )
        	{
        		...
        		else
        		{
        			alert("저장완료.");
                 	if ( EditnRow != -1 )
                    	this.fnDataclear();
        			this.ds_book_hcode_send.deleteRow(0);
                	this.ed_code.setFocus();
        		}
        	}
        	if ( strSvcID == "delete" )
        	{
        		...
        		{
        			this.ds_book_hcode.deleteRow(EditnRow);
                 	this.fnDataclear();
                	this.ed_code.setFocus();
        		}
        	}
        ...
        this.btn_del_onclick = function(obj,e)
        {
        	...
        	if(msg_result = objApp.confirm( "삭제된 데이터는 복원하실수 없습니다.\n 정말 삭제하시겠습니까? " , "삭제처리", "warning" ))
            {
        		...
        		this.ds_book_hcode_send.copyRow(0,this.ds_book_hcode,EditnRow);
        		this.ds_book_hcode_send.setColumn(0,"O_CODE", o_code);
        		this.ds_book_hcode_send.setColumn(0,"ROWTYPE", "D" );
        		//alert(o_code);
        ...
        this.ds_book_hcode_onload = function(obj,e)
        {
        	if(e.reason == 0)
        	{
        		if (this.ds_book_hcode.rowcount == 0)
        			alert("조회된 데이터가 없습니다.");
        	}
        };
        ...
        {
            this.addEventHandler("onload",this.SD6190F_onload,this);
            ...
            this.ds_book_hcode.addEventHandler("onload",this.ds_kwa_onload,this);
        };
        this.loadIncludeScript("SD6190F.xfdl");
