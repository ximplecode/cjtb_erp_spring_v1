(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("SD1070F_GRID5","0.00%","0",null,"100.00%","0.00%",null,null,null,null,null,this);
            obj.set_taborder("0");
        ...
        // User Script
        this.addIncludeScript("SD1070F_GRID5.xfdl","Lib::Lib_etc.xjs");
        this.registerScript("SD1070F_GRID5.xfdl", function() {
        ...
        this.on_initEvent = function()
        {
            ...
            this.SD1070F_GRID5.addEventHandler("onsize",this.SD1040F_GRID1_onsize,this);
        };
        this.loadIncludeScript("SD1070F_GRID5.xfdl");
