(function()
{
    return function()
    {
        ...
        {
            this.set_name("SD2120F_PREVIEW1");
            ...
            obj = new Grid("SD2120F_PREVIEW1","0.00%","0",null,null,"0.2%","0",null,null,null,null,this);
            obj.set_taborder("0");
        ...
        {
            this.SD2120F_PREVIEW1.addEventHandler("onsize",this.SD1040F_GRID1_onsize,this);
        };
        this.loadIncludeScript("SD2120F_PREVIEW1.xfdl");
