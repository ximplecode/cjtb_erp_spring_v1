(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Dataset("ds_bgbr_send", this);
        ...
        // User Script
        this.addIncludeScript("SD6120F.xfdl","Lib::Lib_service.xjs");
        this.addIncludeScript("SD6120F.xfdl","Lib::Lib_etc.xjs");
        this.registerScript("SD6120F.xfdl", function() {
        ...
        this.SD6120F_onload = function(obj,e)
        {
        ...
        {
        	var strUrl = "JSP/sd/select_bgbr.jsp";
        	var strArg;
        ...
        {
        	this.ds_bgbr.setColumn(NewRowNum,"CODE", nexacro.trim(this.ed_code.value));
        	this.ds_bgbr.setColumn(NewRowNum,"NAME", this.ed_name.text);
            this.ds_bgbr_send.addRow();
        	this.ds_bgbr_send.copyRow(0,this.ds_bgbr,NewRowNum);
        	this.ds_bgbr_send.setColumn(0,"O_CODE", nexacro.trim(this.ed_code.value));
        	this.ds_bgbr_send.setColumn(0,"ROWTYPE", "I" );
        }

        //수정모드
        this.fnEdit_data = function()
        {
        	this.ds_bgbr.setColumn(EditnRow,"CODE", nexacro.trim(this.ed_code.value));
        	this.ds_bgbr.setColumn(EditnRow,"NAME", this.ed_name.text);
            this.ds_bgbr_send.addRow();
        	this.ds_bgbr_send.copyRow(0,this.ds_bgbr,EditnRow);
        	this.ds_bgbr_send.setColumn(0,"O_CODE", o_code);
        	this.ds_bgbr_send.setColumn(0,"ROWTYPE", "U" );
        ...
        {
        	EditnRow = e.row;
        	this.ed_code.set_value(this.ds_bgbr.getColumn(e.row,"CODE"));
        	o_code       = this.ds_bgbr.getColumn(e.row,"CODE");
        	this.ed_name.set_value(this.ds_bgbr.getColumn(e.row,"NAME"));
        };

        this.btn_save_onclick = function(obj,e)
        {
        	var strUrl = "JSP/sd/insert_bgbr.jsp";
        	var inDs 	= "ds_bgbr_send=ds_bgbr_send";
        ...
        this.fnTr_Callback = function(strSvcID, nErrorCode, strErrorMag)
        {
        	...
        	if ( strSvcID == "delete" )
        	{
        		...
        		{
        			this.ds_bgbr.deleteRow(EditnRow);
                 	this.fnDataclear();
                	this.ed_code.setFocus();
        		}
        	}
        ...
        this.btn_del_onclick = function(obj,e)
        {
        	...
        	if(msg_result = objApp.confirm( "삭제된 데이터는 복원하실수 없습니다.\n 정말 삭제하시겠습니까? " , "삭제처리", "warning" ))
            {
        		...
        		this.ds_bgbr_send.copyRow(0,this.ds_bgbr,EditnRow);
        		this.ds_bgbr_send.setColumn(0,"O_CODE", o_code);
        		this.ds_bgbr_send.setColumn(0,"ROWTYPE", "D" );
        		//alert(o_code);
        ...
        this.ds_bgbr_onload = function(obj,e)
        {
        	if(e.reason == 0)
        	{
        		if (this.ds_bgbr.rowcount == 0)
        			alert("조회된 데이터가 없습니다.");
        	}
        };
        ...
        {
            this.addEventHandler("onload",this.SD6120F_onload,this);
            ...
            this.ds_bgbr.addEventHandler("onload",this.ds_bgbr_onload,this);
        };
        this.loadIncludeScript("SD6120F.xfdl");
