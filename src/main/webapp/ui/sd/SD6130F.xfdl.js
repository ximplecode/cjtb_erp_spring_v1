(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Dataset("ds_danw_send", this);
        ...
        // User Script
        this.addIncludeScript("SD6130F.xfdl","Lib::Lib_service.xjs");
        this.addIncludeScript("SD6130F.xfdl","Lib::Lib_etc.xjs");
        this.registerScript("SD6130F.xfdl", function() {
        ...
        this.SD6130F_onload = function(obj,e)
        {
        ...
        {
        	var strUrl = "JSP/sd/select_danw.jsp";
        	var strArg;
        	var strDs 	= "ds_danw=ds_danw";
        ...
        {
        	this.ds_danw.setColumn(NewRowNum,"CODE", nexacro.trim(this.ed_code.value));
        	this.ds_danw.setColumn(NewRowNum,"NAME", this.ed_name.text);
            this.ds_danw_send.addRow();
        	this.ds_danw_send.copyRow(0,this.ds_danw,NewRowNum);
        	this.ds_danw_send.setColumn(0,"O_CODE", o_code);
        	this.ds_danw_send.setColumn(0,"ROWTYPE", "I" );
        }

        //수정모드
        this.fnEdit_data = function()
        {
        	this.ds_danw.setColumn(EditnRow,"CODE", nexacro.trim(this.ed_code.value));
        	this.ds_danw.setColumn(EditnRow,"NAME", this.ed_name.text);
            this.ds_danw_send.addRow();
        	this.ds_danw_send.copyRow(0,this.ds_danw,EditnRow);
        	this.ds_danw_send.setColumn(0,"O_CODE", o_code);
        	this.ds_danw_send.setColumn(0,"ROWTYPE", "U" );
        ...
        {
        	EditnRow = e.row;
        	this.ed_code.set_value(this.ds_danw.getColumn(e.row,"CODE"));
        	o_code       = this.ds_danw.getColumn(e.row,"CODE");
        	this.ed_name.set_value(this.ds_danw.getColumn(e.row,"NAME"));
        };

        this.btn_save_onclick = function(obj,e)
        {
        	var strUrl = "JSP/sd/insert_danw.jsp";
        	var inDs 	= "ds_danw_send=ds_danw_send";
        ...
        this.fnTr_Callback = function(strSvcID, nErrorCode, strErrorMag)
        {
        	...
        	if ( strSvcID == "delete" )
        	{
        		...
        		{
        			this.ds_danw.deleteRow(EditnRow);
                 	this.fnDataclear();
                	this.ed_code.setFocus();
        		}
        	}
        ...
        this.btn_del_onclick = function(obj,e)
        {
        	...
        	if(msg_result = objApp.confirm( "삭제된 데이터는 복원하실수 없습니다.\n 정말 삭제하시겠습니까? " , "삭제처리", "warning" ))
            {
        		...
        		this.ds_danw_send.copyRow(0,this.ds_danw,EditnRow);
        		this.ds_danw_send.setColumn(0,"O_CODE", o_code);
        		this.ds_danw_send.setColumn(0,"ROWTYPE", "D" );
        		//alert(o_code);
        ...
        this.ds_danw_onload = function(obj,e)
        {
        	if(e.reason == 0)
        	{
        		if (this.ds_danw.rowcount == 0)
        			alert("조회된 데이터가 없습니다.");
        	}
        };
        ...
        {
            this.addEventHandler("onload",this.SD6130F_onload,this);
            ...
            this.ds_danw.addEventHandler("onload",this.ds_danw_onload,this);
        };
        this.loadIncludeScript("SD6130F.xfdl");
