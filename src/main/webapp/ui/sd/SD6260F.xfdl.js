(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Dataset("ds_jang_send", this);
            ...
            obj = new Static("Static01_03","41.5%","110","127","40",null,null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_text("명칭");
            obj.set_background("#ffffff");
            obj.set_color("#10aea9");
            ...
            obj = new Static("Static01_02","150","110",null,"40","Static01_03:-2",null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_background("#ffffff");
            obj.set_color("#10aea9");
            obj.set_font("bold 10pt/normal \"Arial\"");
            ...
            obj = new Static("Static02_06","Static02_05:-2","248",null,"40","Static02_07:-2",null,null,null,null,null,this);
            obj.set_taborder("20");
            obj.set_background("#ffffff");
            obj.set_color("#10aea9");
            obj.set_font("bold 10pt/normal \"Arial\"");
            ...
            obj = new Static("Static02_02","Static02_01:-2","210",null,"40","Static02_03:-2",null,null,null,null,null,this);
            obj.set_taborder("21");
            obj.set_background("#ffffff");
            obj.set_color("#10aea9");
            obj.set_font("bold 10pt/normal \"Arial\"");
            ...
            obj = new Grid("grd_view","37","Static02_07:10",null,null,"42","42",null,null,"50",null,this);
            obj.set_taborder("26");
            obj.set_binddataset("ds_jang");
        ...
        // User Script
        this.addIncludeScript("SD6260F.xfdl","Lib::Lib_service.xjs");
        this.addIncludeScript("SD6260F.xfdl","Lib::Lib_etc.xjs");
        this.registerScript("SD6260F.xfdl", function() {
        ...
        this.SD6260F_onload = function(obj,e)
        {
        ...
        {
        	var strUrl = "JSP/sd/select_jang.jsp";
        	var strArg;
        	var strDs 	= "ds_jang=ds_jang";
        	var option1 = nexacro.wrapQuote(this.cmb_search.index);
        ...
        {
        	this.ds_jang.setColumn(NewRowNum,"CODE", nexacro.trim(this.ed_code.value));
        	this.ds_jang.setColumn(NewRowNum,"NAME", this.ed_name.text);
            this.ds_jang_send.addRow();
        	this.ds_jang_send.copyRow(0,this.ds_jang,NewRowNum);
        	this.ds_jang_send.setColumn(0,"O_CODE", this.ed_code.value);
        	this.ds_jang_send.setColumn(0,"ROWTYPE", "I" );
        }

        //수정모드
        this.fnEdit_data = function()
        {
        	this.ds_jang.setColumn(EditnRow,"CODE", nexacro.trim(this.ed_code.value));
        	this.ds_jang.setColumn(EditnRow,"NAME", this.ed_name.text);
            this.ds_jang_send.addRow();
        	this.ds_jang_send.copyRow(0,this.ds_jang,EditnRow);
        	this.ds_jang_send.setColumn(0,"O_CODE", o_code);
        	this.ds_jang_send.setColumn(0,"ROWTYPE", "U" );
        ...
        {
        	EditnRow = e.row;
        	this.ed_code.set_value(this.ds_jang.getColumn(e.row,"CODE"));
        	o_code       = this.ds_jang.getColumn(e.row,"CODE");
        	this.ed_name.set_value(this.ds_jang.getColumn(e.row,"NAME"));
        };

        this.btn_save_onclick = function(obj,e)
        {
        	var strUrl = "JSP/sd/insert_jang.jsp";
        	var inDs 	= "ds_jang_send=ds_jang_send";
        ...
        this.fnTr_Callback = function(strSvcID, nErrorCode, strErrorMag)
        {
        	...
        	if ( strSvcID == "delete" )
        	{
        		...
        		{
        			this.ds_jang.deleteRow(EditnRow);
                 	this.fnDataclear();
                	this.ed_code.setFocus();
        		}
        	}
        ...
        this.btn_del_onclick = function(obj,e)
        {
        	...
        	if(msg_result = objApp.confirm( "삭제된 데이터는 복원하실수 없습니다.\n 정말 삭제하시겠습니까? " , "삭제처리", "warning" ))
            {
        		...
        		this.ds_jang_send.copyRow(0,this.ds_jang,EditnRow);
        		this.ds_jang_send.setColumn(0,"O_CODE", o_code);
        		this.ds_jang_send.setColumn(0,"ROWTYPE", "D" );
        		//alert(o_code);
        ...
        this.ds_jang_onload = function(obj,e)
        {
        	if(e.reason == 0)
        	{
        		if (this.ds_jang.rowcount == 0)
        			alert("조회된 데이터가 없습니다.");
        	}
        };
        ...
        {
            this.addEventHandler("onload",this.SD6260F_onload,this);
            ...
            this.ds_jang.addEventHandler("onload",this.ds_bdbr_onload,this);
        };
        this.loadIncludeScript("SD6260F.xfdl");
