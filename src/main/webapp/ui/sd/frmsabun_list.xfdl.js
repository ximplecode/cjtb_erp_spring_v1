(function()
{
    return function()
    {
        ...
        {
            this.set_name("frmsabun_list");
            this.set_titletext("New Form");
            if (Form == this.constructor)
            {
                this._setFormPosition(492,470);
            }
            ...
            obj = new Static("Static00","260","6","55","29",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("성명");
            ...
            obj = new Edit("edt_name","316","6","115","29",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            this.addChild(obj.name, obj);

            obj = new Button("btn_search","433","6","51","29",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Grid("grd_insa","252","45","233","385",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            ...
            obj = new Grid("grd_buse","7","3","246","427",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",492,470,this,function(p){});
        ...
        // User Script
        this.addIncludeScript("frmsabun_list.xfdl","Lib::Lib_service.xjs");
        this.registerScript("frmsabun_list.xfdl", function() {
        ...
        this.frmsabun_list_onload = function(obj,e)
        {
        ...
        {
            this.addEventHandler("onload",this.frmsabun_list_onload,this);
        ...
        this.loadIncludeScript("frmsabun_list.xfdl");
