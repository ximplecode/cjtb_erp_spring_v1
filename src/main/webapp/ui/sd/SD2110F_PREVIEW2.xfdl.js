(function()
{
    return function()
    {
        ...
        {
            this.set_name("SD2110F_PREVIEW2");
        ...
        {
            this.SD2110F_PREVIEW2.addEventHandler("onsize",this.SD1040F_GRID1_onsize,this);
        };
        this.loadIncludeScript("SD2110F_PREVIEW2.xfdl");
