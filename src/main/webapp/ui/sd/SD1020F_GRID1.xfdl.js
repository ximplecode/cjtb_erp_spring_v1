(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("SD1020F_GRID1.xfdl","Lib::Lib_etc.xjs");
        this.registerScript("SD1020F_GRID1.xfdl", function() {
        ...
        */
        ...
        {
            this.addEventHandler("ontimer",this.SD1020F_GRID1_ontimer,this);
            this.addEventHandler("onsize",this.SD1020F_GRID1_onsize,this);
            this.SD1020F_GRID1.addEventHandler("onsize",this.SD1020F_GRID1_onsize,this);
        };
        this.loadIncludeScript("SD1020F_GRID1.xfdl");
