(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("SD8101F_GRID1","0%","0",null,"100.00%","0%",null,null,null,null,null,this);
            obj.set_taborder("0");
        ...
        // User Script
        this.addIncludeScript("SD8101F_GRID1.xfdl","Lib::Lib_etc.xjs");
        this.registerScript("SD8101F_GRID1.xfdl", function() {
        ...
        */
        this.SD8101F_GRID1_onload = function(obj,e)
        {
        ...
        {
            this.addEventHandler("onsize",this.SD8101F_GRID1_onsize,this);
            this.addEventHandler("ontimer",this.SD8101F_GRID1_ontimer,this);
            this.addEventHandler("onload",this.SD8101F_GRID1_onload,this);
        };
        this.loadIncludeScript("SD8101F_GRID1.xfdl");
