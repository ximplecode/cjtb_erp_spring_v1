(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("SD1020F_GRID6","0.00%","0",null,"100.00%","0.00%",null,null,null,null,null,this);
            obj.set_taborder("0");
        ...
        // User Script
        this.addIncludeScript("SD1020F_GRID6.xfdl","Lib::Lib_etc.xjs");
        this.registerScript("SD1020F_GRID6.xfdl", function() {
        this.executeIncludeScript("Lib::Lib_etc.xjs"); /*include "Lib::Lib_etc.xjs"*/;

        this.SD1020F_GRID6_onsize = function(obj,e)
        {
        	var l;
        ...
        this.SD1020F_GRID6_ontimer = function(obj,e)
        {
        	this.setTimer(0,1);
        };
        ...
        {
            this.addEventHandler("onsize",this.SD1020F_GRID6_onsize,this);
            this.addEventHandler("ontimer",this.SD1020F_GRID6_ontimer,this);
        };
        this.loadIncludeScript("SD1020F_GRID6.xfdl");
