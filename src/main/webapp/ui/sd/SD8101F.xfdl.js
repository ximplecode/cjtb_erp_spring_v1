(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"DATA\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CODE\">0</Col><Col id=\"DATA\">교판)일자별선수금현황</Col></Row><Row><Col id=\"CODE\">1</Col><Col id=\"DATA\">속셈)일자별선수금현황</Col></Row><Row><Col id=\"CODE\">2</Col><Col id=\"DATA\">자가)일자별수금현황</Col></Row><Row><Col id=\"CODE\">3</Col><Col id=\"DATA\">입금현황</Col></Row><Row><Col id=\"CODE\">4</Col><Col id=\"DATA\">월별)입금현황</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_1", this);
            obj.set_keystring("SYYMM");
            obj._setContents("<ColumnInfo><Column id=\"SYYMM\" type=\"STRING\" size=\"256\"/><Column id=\"S_DATE\" type=\"STRING\" size=\"256\"/><Column id=\"CUST_GB\" type=\"STRING\" size=\"256\"/><Column id=\"CUST_CD\" type=\"STRING\" size=\"256\"/><Column id=\"CUST_NM\" type=\"STRING\" size=\"256\"/><Column id=\"MYMM\" type=\"STRING\" size=\"256\"/><Column id=\"CNT\" type=\"STRING\" size=\"256\"/><Column id=\"MDD\" type=\"STRING\" size=\"256\"/><Column id=\"U_SUGM\" type=\"FLOAT\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static07","849","12","64","301",null,null,null,null,null,null,this);
            obj.set_taborder("24");
            obj.set_text("업체구분");
            obj.set_background("#ffffff");
            obj.set_color("#10aea9");
            ...
            obj = new Static("Static08","1113","12","64","301",null,null,null,null,null,null,this);
            obj.set_taborder("25");
            obj.set_text("적요");
            obj.set_background("#ffffff");
            obj.set_color("#10aea9");
            ...
            obj = new Grid("grd_ioyh00","Static08:-2","12","204","301",null,null,null,null,null,null,this);
            obj.set_taborder("20");
            ...
            obj = new Grid("grd_ioyh","Static07:-2","12","204","301",null,null,null,null,null,null,this);
            obj.set_taborder("19");
            ...
            obj = new MaskEdit("ed_ssjuk","157","55","70","30",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_maskchar("_");
            obj.set_enableevent("true");
            obj.set_accessibilityrole("edit");
        ...
        // User Script
        this.addIncludeScript("SD8101F.xfdl","Lib::Lib_service.xjs");
        this.addIncludeScript("SD8101F.xfdl","Lib::Lib_etc.xjs");
        this.registerScript("SD8101F.xfdl", function() {
        ...
        this.SD8110F_onload = function(obj,e)
        {
        	...
        	this.ed_mature_symd.set_value(u_yy);
        	this.ed_mature_eymd.set_value(u_yy);
        ...
        this.btn_printview_onclick = function(obj,e)
        {
        	...
        	Sd_sql     =  "    where a.S_DATE >= '" + this.ed_work_symd.value +"'";
        	...
        	if (( this.ed_mature_symd.value != "" ) || ( this.ed_mature_eymd.value != "" ))
        	{
        		Sd_sql    = Sd_sql + "   and a.u_mdate  >= '" + this.ed_mature_symd.value +"'";
        		Sd_sql    = Sd_sql + "   and a.u_mdate  <= '" + this.ed_mature_eymd.value +"'";
        	}
        	if (( this.ed_mature_symd.value != "" ) || ( this.ed_mature_eymd.value != "" ))
        	{
        		Sd_sql1    = Sd_sql1 + "   where syymm  >= '" + (this.ed_mature_symd.value).substr(0,6) +"'";
        		Sd_sql1    = Sd_sql1 + "     and syymm  <= '" + (this.ed_mature_eymd.value).substr(0,6) +"'";
        	}
        	...
        	strArg += " syymm="+nexacro.wrapQuote((this.ed_mature_symd.value).substr(0,6));
        	strArg += " eyymm="+nexacro.wrapQuote((this.ed_mature_eymd.value).substr(0,6));
        	...
        	switch(this.cmb_print_select.index)
        	{
        		case 0:
        			if(obj.name == "btn_printview" ) // 미리보기 일때
        			{
        				var strDs = "ds_1=ds_1";
        				strArg += "gubn=0";
        				this.gfn_TransactionP("ds_1","JSP/sd/SD8101F_DS1_SELECT.jsp", strDs, strDs, strArg, "fnDSCallback", true, "P", false, this);
        			}
        			else if(obj.name == "btn_print")
        			{
        				rdfile = gv_urlMrd+"/sd/SD81011r.mrd";
        		...
        		case 1:
        			if(obj.name == "btn_printview" ) // 미리보기 일때
        			{
        				var strDs = "ds_1=ds_1";
        				strArg += "gubn=0";
        				this.gfn_TransactionP("ds_2","JSP/sd/SD8101F_DS1_SELECT.jsp", strDs, strDs, strArg, "fnDSCallback", true, "P", false, this);
        			}
        			else if(obj.name == "btn_print")
        			{
        				rdfile = gv_urlMrd+"/sd/SD81012r.mrd";
        				this.lfn_showModal("print", {rdUrl:rdfile, rdParam:rdopt}, "mk::MKRDF.xfdl", "", this, 0, 0, 1400, 760);
        			}
        			break;
        		case 2:
        			if(obj.name == "btn_printview" ) // 미리보기 일때
        			{
        				var strDs = "ds_1=ds_1";
        				strArg += "gubn=1";
        				this.gfn_TransactionP("ds_3","JSP/sd/SD8101F_DS1_SELECT.jsp", strDs, strDs, strArg, "fnDSCallback", true, "P", false, this);
        			}
        			else if(obj.name == "btn_print")
        			{
        				rdfile = gv_urlMrd+"/sd/SD81013r.mrd";
        				this.lfn_showModal("print", {rdUrl:rdfile, rdParam:rdopt}, "mk::MKRDF.xfdl", "", this, 0, 0, 1400, 760);
        			}
        			break;
        		case 3: // mrd 존재하지 않음
        			...
        			{
        				var strDs = "ds_4=ds_4";
        				this.Div00.set_url("sd::SD8101F_GRID4.xfdl");
        				this.gfn_TransactionP("ds_4","JSP/sd/SD8101F_DS4_SELECT.jsp", strDs, strDs, strArg, "fnDSCallback", true, "P", false, this);
        			}
        			else if(obj.name == "btn_print")
        			{
        		...
        		case 4: // mrd 존재하지 않음
        			...
        			{
        				var strDs = "ds_5=ds_5";
        				this.Div00.set_url("sd::SD8101F_GRID5.xfdl");
        				this.gfn_TransactionP("ds_5","JSP/sd/SD8101F_DS5_SELECT.jsp", strDs, strDs, strArg, "fnDSCallback", true, "P", false, this);
        			}
        			else if(obj.name == "btn_print")
        			{
        ...
        this.fnDSCallback = function(Trid, ErroCode, ErrorMsg)
        {
        	...
        	if(Trid.substr(0,3) == "ds_" && this.ds_1.rowcount <= 0)  // ds_1만 사용
        	{
        		alert('조회된 데이터가 없습니다.');
        		return;
        	}
        	...
        	{
        		this.Div00.set_url();
        		this.Div00.set_url("sd::SD8101F_GRID1.xfdl");
        	}
        	else if(Trid == "ds_2")
        	{
        		this.Div00.set_url();
        		this.Div00.set_url("sd::SD8101F_GRID2.xfdl");
        	}
        	else if(Trid == "ds_3")
        	{
        		this.Div00.set_url();
        		this.Div00.set_url("sd::SD8101F_GRID3.xfdl");
        	}
        	/* // mrd 존재하지않음
        	else if(Trid == "ds_4")
        	{
        ...
        this.loadIncludeScript("SD8101F.xfdl");
