(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("SD1020F_GRID14","0.00%","0",null,"100.00%","0.00%",null,null,null,null,null,this);
            obj.set_taborder("0");
        ...
        // User Script
        this.addIncludeScript("SD1020F_GRID14.xfdl","Lib::Lib_etc.xjs");
        this.registerScript("SD1020F_GRID14.xfdl", function() {
        this.executeIncludeScript("Lib::Lib_etc.xjs"); /*include "Lib::Lib_etc.xjs"*/;

        this.SD1020F_GRID14_onsize = function(obj,e)
        {
        	var l;
        	...
        	trace(l);
        	this.killTimer(0);
        	this.lfn_grdAutofit(this.SD1020F_GRID14);
        };

        this.SD1020F_GRID14_ontimer = function(obj,e)
        {
        	this.setTimer(0,1);
        };
        ...
        {
            this.addEventHandler("onsize",this.SD1020F_GRID14_onsize,this);
            this.addEventHandler("ontimer",this.SD1020F_GRID14_ontimer,this);
        };
        this.loadIncludeScript("SD1020F_GRID14.xfdl");
