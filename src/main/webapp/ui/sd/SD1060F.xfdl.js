(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"value\" type=\"STRING\" size=\"256\"/><Column id=\"name\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"value\">1</Col><Col id=\"name\">일자별 폐기현황</Col></Row><Row><Col id=\"value\">2</Col><Col id=\"name\">도서별 폐기현황</Col></Row><Row><Col id=\"value\">3</Col><Col id=\"name\">도서별 폐기집계</Col></Row></Rows>");
            ...
            obj._setContents("<ColumnInfo><Column id=\"BYMD\" type=\"STRING\" size=\"256\"/><Column id=\"JP_GB\" type=\"STRING\" size=\"256\"/><Column id=\"NUM\" type=\"STRING\" size=\"256\"/><Column id=\"IOYH_CD\" type=\"STRING\" size=\"256\"/><Column id=\"SGRP_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"SGRP_NM\" type=\"STRING\" size=\"256\"/><Column id=\"BOOK_CD\" type=\"STRING\" size=\"256\"/><Column id=\"BYY\" type=\"STRING\" size=\"256\"/><Column id=\"BOOK_NM\" type=\"STRING\" size=\"256\"/><Column id=\"QTY1\" type=\"INT\" size=\"256\"/><Column id=\"QTY2\" type=\"INT\" size=\"256\"/><Column id=\"BGBR_NM\" type=\"STRING\" size=\"256\"/><Column id=\"Y_NM\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"SGRP_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"SGRP_NM\" type=\"STRING\" size=\"256\"/><Column id=\"BOOK_CD\" type=\"STRING\" size=\"256\"/><Column id=\"BYY\" type=\"STRING\" size=\"256\"/><Column id=\"BOOK_NM\" type=\"STRING\" size=\"256\"/><Column id=\"JP_GB\" type=\"STRING\" size=\"256\"/><Column id=\"IOYH_CD\" type=\"STRING\" size=\"256\"/><Column id=\"QTY1\" type=\"INT\" size=\"256\"/><Column id=\"QTY2\" type=\"INT\" size=\"256\"/><Column id=\"QTY3\" type=\"INT\" size=\"256\"/><Column id=\"QTY4\" type=\"INT\" size=\"256\"/><Column id=\"QTY5\" type=\"INT\" size=\"256\"/><Column id=\"QTY6\" type=\"INT\" size=\"256\"/><Column id=\"QTY7\" type=\"INT\" size=\"256\"/><Column id=\"QTY8\" type=\"INT\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("SD1060F.xfdl","Lib::Lib_service.xjs");
        this.addIncludeScript("SD1060F.xfdl","Lib::Lib_etc.xjs");
        this.addIncludeScript("SD1060F.xfdl","Lib::Lib_sd.xjs");
        this.registerScript("SD1060F.xfdl", function() {
        ...
        //======s_sql2
        	...
        	if(event_id == "btn_printview" ) // 미리보기 일때
        	{
        		...
        		{
        			case '1' : // 일자별 폐기현황
        					this.Div00.set_url("sd::SD1060F_GRID1.xfdl");
        					...
        					this.gfn_TransactionP("ds1_select","JSP/sd/SD1060F_DS1_SELECT.jsp", inds, outds, strArg, "fnCallback", true, "P", false, this);

        					break;
        			case '2' : // 도서별 페기현황
        					this.Div00.set_url("sd::SD1060F_GRID2.xfdl");
        					...
        					this.gfn_TransactionP("ds2_select","JSP/sd/SD1060F_DS2_SELECT.jsp", inds, outds, strArg, "fnCallback", true, "P", false, this);

        					break;
        			case '3' : // 도서별 폐기집계
        					this.Div00.set_url("sd::SD1060F_GRID3.xfdl");
        					...
        					this.gfn_TransactionP("ds3_select","JSP/sd/SD1060F_DS3_SELECT.jsp", inds, outds, strArg, "fnCallback", true, "P", false, this);
        ...
        this.SD1060F_onload = function(obj,e)
        {
        ...
        {
        	if (num == 1) return nexacro.getApplication().gv_urlNext+"/rpt/sd/SD1061r.mrd"; // 일자별 폐기현황
        	else if (num == 2) return nexacro.getApplication().gv_urlNext+"/rpt/sd/SD1062r.mrd"; // 도서별 폐기현황
        	else if (num == 3) return nexacro.getApplication().gv_urlNext+"/rpt/sd/SD1063r.mrd"; // 도서별 폐기집계
        ...
        this.btn_excel_onclick = function(obj,e)
        {
        	...
        	if ( this.Div00.url == "sd::SD1060F_GRID1.xfdl" ) {
        		var ret = this.exportObj.addExportItem(nexacro.ExportItemTypes.GRID, this.Div00.form.SD1060F_GRID1, "Sheet1!A1");
        		filename = "1"; }
        	else if ( this.Div00.url == "sd::SD1060F_GRID2.xfdl" ) {
        		var ret = this.exportObj.addExportItem(nexacro.ExportItemTypes.GRID, this.Div00.form.SD1060F_GRID2, "Sheet1!A1");
        		filename = "2"; }
        	else if ( this.Div00.url == "sd::SD1060F_GRID3.xfdl" ) {
        		var ret = this.exportObj.addExportItem(nexacro.ExportItemTypes.GRID, this.Div00.form.SD1060F_GRID3, "Sheet1!A1");
        		filename = "3"; }
        	else if ( this.Div00.url == "sd::SD1060F_GRID4.xfdl" ) {
        		var ret = this.exportObj.addExportItem(nexacro.ExportItemTypes.GRID, this.Div00.form.SD1060F_GRID4, "Sheet1!A1");
        		filename = "4"; }
        ...
        {
            this.addEventHandler("onload",this.SD1060F_onload,this);
        ...
        this.loadIncludeScript("SD1060F.xfdl");
