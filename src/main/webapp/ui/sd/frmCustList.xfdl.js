(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("frmCustList.xfdl","Lib::Lib_service.xjs");
        this.addIncludeScript("frmCustList.xfdl","Lib::Lib_etc.xjs");
        this.addIncludeScript("frmCustList.xfdl","Lib::Lib_sd.xjs");
        this.registerScript("frmCustList.xfdl", function() {
        ...
        this.loadIncludeScript("frmCustList.xfdl");
