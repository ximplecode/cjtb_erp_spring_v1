(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("SD1030F_GRID9","0.00%","0",null,"100.00%","0.00%",null,null,null,null,null,this);
            obj.set_taborder("0");
        ...
        // User Script
        this.addIncludeScript("SD1030F_GRID9.xfdl","Lib::Lib_etc.xjs");
        this.registerScript("SD1030F_GRID9.xfdl", function() {
        this.executeIncludeScript("Lib::Lib_etc.xjs"); /*include "Lib::Lib_etc.xjs"*/;


        this.SD1030F_GRID9_ontimer = function(obj,e)
        {
        	var l;
        	...
        	trace(l);
        	this.killTimer(0);
        	this.lfn_grdAutofit(this.SD1030F_GRID9);
        };

        this.SD1030F_GRID9_onsize = function(obj,e)
        {
        	this.setTimer(0,1);
        };
        ...
        {
            this.addEventHandler("onsize",this.SD1030F_GRID9_onsize,this);
            this.addEventHandler("ontimer",this.SD1030F_GRID9_ontimer,this);
            this.SD1030F_GRID9.addEventHandler("onsize",this.SD1030F_GRID9_onsize,this);
        };
        this.loadIncludeScript("SD1030F_GRID9.xfdl");
