(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("SD1010F_GRID4","0%","0",null,"100.00%","0%",null,null,null,null,null,this);
            obj.set_taborder("0");
        ...
        // User Script
        this.addIncludeScript("SD1010F_GRID4.xfdl","Lib::Lib_etc.xjs");
        this.registerScript("SD1010F_GRID4.xfdl", function() {
        this.executeIncludeScript("Lib::Lib_etc.xjs"); /*include "Lib::Lib_etc.xjs"*/;

        this.SD1010F_GRID4_onsize = function(obj,e)
        {
        	this.setTimer(0,1);
        };

        this.SD1010F_GRID4_ontimer = function(obj,e)
        {
        	var l;
        ...
        {
            this.addEventHandler("onsize",this.SD1010F_GRID4_onsize,this);
            this.addEventHandler("ontimer",this.SD1010F_GRID4_ontimer,this);
        };
        this.loadIncludeScript("SD1010F_GRID4.xfdl");
