(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("SD8160F_GRID3","0%","0",null,"100.00%","0%",null,null,null,null,null,this);
            obj.set_taborder("0");
        ...
        // User Script
        this.addIncludeScript("SD8160F_GRID3.xfdl","Lib::Lib_etc.xjs");
        this.registerScript("SD8160F_GRID3.xfdl", function() {
        this.executeIncludeScript("Lib::Lib_etc.xjs"); /*include "Lib::Lib_etc.xjs"*/;

        /*
        this.SD8160F_GRID3_onsize = function(obj:nexacro.Form,e:nexacro.SizeEventInfo)
        {
        	this.setTimer(0,1);
        };

        this.SD8160F_GRID3_ontimer = function(obj:nexacro.Form,e:nexacro.TimerEventInfo)
        {
        	var l;
        ...
        */
        ...
        {
            this.addEventHandler("onsize",this.SD8130F_GRID3_onsize,this);
            this.addEventHandler("ontimer",this.SD8130F_GRID3_ontimer,this);
        };
        this.loadIncludeScript("SD8160F_GRID3.xfdl");
