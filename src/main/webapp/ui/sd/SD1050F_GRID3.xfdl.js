(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("SD1050F_GRID3","0.00%","0",null,"100.00%","0.00%",null,null,null,null,null,this);
            obj.set_taborder("0");
        ...
        // User Script
        this.addIncludeScript("SD1050F_GRID3.xfdl","Lib::Lib_etc.xjs");
        this.registerScript("SD1050F_GRID3.xfdl", function() {
        ...
        */
        ...
        this.loadIncludeScript("SD1050F_GRID3.xfdl");
