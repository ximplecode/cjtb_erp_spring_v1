(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"NAME\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CODE\">0</Col><Col id=\"NAME\">영업코드명순</Col></Row><Row><Col id=\"CODE\">1</Col><Col id=\"NAME\">영업코드순</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_ccode", this);
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"NAME\" type=\"STRING\" size=\"256\"/><Column id=\"CHK\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_ccode_send", this);
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"NAME\" type=\"STRING\" size=\"256\"/><Column id=\"CHK\" type=\"STRING\" size=\"256\"/><Column id=\"O_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"ROWTYPE\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            
            // UI Components Initialize
            obj = new Static("Static00","56","11","300","59",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("영업구분 등록");
            ...
            obj = new Static("Static01_03_00_00_00","Static01:-50.00%","108","127","38",null,null,null,null,null,null,this);
            obj.set_taborder("27");
            obj.set_text("영업코드명");
            obj.set_background("#ffffff");
            obj.set_color("#10aea9");
            ...
            obj = new Static("Static01_02","Static01_01:-2","Static01:-2",null,"38","Static01_03_00_00_00:-2",null,"56",null,null,null,this);
            obj.set_taborder("11");
            obj.set_background("#ffffff");
            obj.set_color("#10aea9");
            obj.set_font("bold 10pt/normal \"Arial\"");
            ...
            obj.set_taborder("24");
            obj.set_binddataset("ds_ccode");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"130\"/><Column size=\"200\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"영업코드\"/><Cell col=\"1\" text=\"영업코드명\"/></Band><Band id=\"body\"><Cell text=\"bind:CODE\"/><Cell col=\"1\" text=\"bind:NAME\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new MaskEdit("ed_code","Static01_01:10","113",null,"28","Static01_03_00_00_00:10",null,"36",null,null,null,this);
            obj.set_taborder("0");
            obj.set_maskchar("_");
            obj.set_enableevent("true");
            obj.set_accessibilityrole("edit");
            ...
            obj = new Edit("ed_name","Static01_03_00_00_00:10","113",null,"28","Static01:-99.20%",null,null,null,null,null,this);
            obj.set_taborder("1");
            this.addChild(obj.name, obj);

            obj = new Edit("ed_s_name","Static02_05:10","233",null,"28","Static02_07:10",null,null,null,null,null,this);
            obj.set_taborder("28");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        // User Script
        this.addIncludeScript("SD6040F.xfdl","Lib::Lib_service.xjs");
        this.addIncludeScript("SD6040F.xfdl","Lib::Lib_etc.xjs");
        this.registerScript("SD6040F.xfdl", function() {
        ...
        this.SD6040F_onload = function(obj,e)
        {
        ...
        this.ds_ccode_onload = function(obj,e)
        {
        	if(e.reason == 0)
        	{
        ...
        {
            this.addEventHandler("onload",this.SD6040F_onload,this);
            ...
            this.ed_s_name.addEventHandler("onkeydown",this.common_onkeydown,this);
            this.ds_ccode.addEventHandler("onload",this.ds_baesong_onload,this);
            this.ds_ccode_send.addEventHandler("onload",this.ds_book_scode_onload,this);
        };
        this.loadIncludeScript("SD6040F.xfdl");
