(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("SD1130F_GRID13","0.00%","0",null,"100.00%","0.00%",null,null,null,null,null,this);
            obj.set_taborder("0");
        ...
        // User Script
        this.addIncludeScript("SD1130F_GRID13.xfdl","Lib::Lib_etc.xjs");
        this.registerScript("SD1130F_GRID13.xfdl", function() {
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.SD1130F_GRID13.addEventHandler("onsize",this.SD1040F_GRID1_onsize,this);
        };
        this.loadIncludeScript("SD1130F_GRID13.xfdl");
