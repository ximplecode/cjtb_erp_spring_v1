(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"DATA\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CODE\">0</Col><Col id=\"DATA\">계산서 발행현황</Col></Row><Row><Col id=\"CODE\">1</Col><Col id=\"DATA\">세금계산서 발행현황</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_1", this);
            obj.set_keystring("GB1+GB2");
            obj._setContents("<ColumnInfo><Column id=\"S_YY\" type=\"STRING\" size=\"256\"/><Column id=\"S_MM\" type=\"STRING\" size=\"256\"/><Column id=\"CGB\" type=\"STRING\" size=\"256\"/><Column id=\"GB1\" type=\"STRING\" size=\"256\"/><Column id=\"GB2\" type=\"STRING\" size=\"256\"/><Column id=\"GB3\" type=\"STRING\" size=\"256\"/><Column id=\"S_NO\" type=\"STRING\" size=\"256\"/><Column id=\"SA_NO\" type=\"STRING\" size=\"256\"/><Column id=\"SANG\" type=\"STRING\" size=\"256\"/><Column id=\"GMC\" type=\"STRING\" size=\"256\"/><Column id=\"GMV\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj.set_border("2px solid #10aea9");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"30\"/><Column size=\"80\"/><Column size=\"30\"/><Column size=\"50\"/><Column size=\"200\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"선택\" displaytype=\"text\"/><Cell col=\"1\" text=\"구분\"/><Cell col=\"2\" text=\"GU\"/><Cell col=\"3\" text=\"코드\"/><Cell col=\"4\" text=\"거래처명\"/><Cell col=\"5\" text=\"사업자번호\"/><Cell col=\"6\" text=\"주민번호\"/></Band><Band id=\"body\"><Cell text=\"bind:CHK\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"bind:GBNM\"/><Cell col=\"2\" text=\"bind:GUBN\"/><Cell col=\"3\" text=\"bind:CODE\"/><Cell col=\"4\" text=\"bind:NAME\"/><Cell col=\"5\" text=\"bind:F_SAUPNO\"/><Cell col=\"6\" text=\"bind:F_DPNO\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Static("Static07","849","50","127","263",null,null,null,null,null,null,this);
            obj.set_taborder("20");
            obj.set_text("업체구분");
            obj.set_background("#ffffff");
            obj.set_color("#10aea9");
            ...
            obj = new Grid("grd_ioyh","Static07:-2","50","405","263",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            ...
            obj = new Calendar("ed_work_symd","Static01:22","17","120","30",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new MaskEdit("ed_egb","1141","17","40","30",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_maskchar("_");
            obj.set_enableevent("true");
            obj.set_accessibilityrole("edit");
            ...
            obj = new Static("Static11","1110","17","19","30",null,null,null,null,null,null,this);
            obj.set_taborder("27");
            obj.set_text("~");
            obj.set_textAlign("center");
            this.addChild(obj.name, obj);

            obj = new Edit("ed_scust","272","55","70","30",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            this.addChild(obj.name, obj);

            obj = new Edit("ed_name","347","55","230","30",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static01_00","438","12","127","40",null,null,null,null,null,null,this);
            obj.set_taborder("30");
            obj.set_text("작업구간");
            obj.set_background("#ffffff");
            obj.set_color("#10aea9");
            ...
            obj = new Static("Static00_01_00","563","12","288","40",null,null,null,null,null,null,this);
            obj.set_taborder("31");
            obj.set_background("#ffffff");
            obj.set_color("#10aea9");
            obj.set_font("bold 10pt/normal \"Arial\"");
            ...
            obj = new MaskEdit("ed_sno","592","17","65","30",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_maskchar("_");
            obj.set_enableevent("true");
            obj.set_accessibilityrole("edit");
            ...
            obj = new MaskEdit("ed_eno","762","17","65","30",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_maskchar("_");
            obj.set_enableevent("true");
            obj.set_accessibilityrole("edit");
            ...
            obj = new Static("Static11_00","698","17","19","30",null,null,null,null,null,null,this);
            obj.set_taborder("32");
            obj.set_text("~");
            obj.set_textAlign("center");
            this.addChild(obj.name, obj);

            obj = new Edit("ed_jumin","660","55","100","30",null,null,null,null,null,null,this);
            obj.set_taborder("33");
            this.addChild(obj.name, obj);

            obj = new Static("Static11_00_00","590","55","70","30",null,null,null,null,null,null,this);
            obj.set_taborder("34");
            obj.set_text("주민번호");
            obj.set_textAlign("center");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("SD8140F.xfdl","Lib::Lib_service.xjs");
        this.addIncludeScript("SD8140F.xfdl","Lib::Lib_etc.xjs");
        this.registerScript("SD8140F.xfdl", function() {
        this.executeIncludeScript("Lib::Lib_service.xjs"); /*include "Lib::Lib_service.xjs"*/;
        this.executeIncludeScript("Lib::Lib_etc.xjs"); /*include "Lib::Lib_etc.xjs"*/;
        var gv_urlMrd = nexacro.getApplication().gv_urlMrd;
        var gv_urlXeni = nexacro.getApplication().gv_urlXeni;

        this.SD8140F_onload = function(obj,e)
        {
        ...
        this.SD8140F_ontimer = function(obj,e)
        {
        	if(e.timerid==0)
        	{
        		this.fnExcellExport();
        ...
        {
            this.addEventHandler("onload",this.SD8140F_onload,this);
            this.addEventHandler("ontimer",this.SD8140F_ontimer,this);
            ...
            this.ed_sno.addEventHandler("onkillfocus",this.common_kill_focus,this);
            this.ed_sno.addEventHandler("onsetfocus",this.common_set_focus,this);
            this.ed_eno.addEventHandler("onkillfocus",this.common_kill_focus,this);
            this.ed_eno.addEventHandler("onsetfocus",this.common_set_focus,this);
            this.ed_jumin.addEventHandler("onkillfocus",this.common_kill_focus,this);
            this.ed_jumin.addEventHandler("onsetfocus",this.common_set_focus,this);
        };
        this.loadIncludeScript("SD8140F.xfdl");
