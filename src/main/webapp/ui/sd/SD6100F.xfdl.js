(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Dataset("ds_bdbr_send", this);
        ...
        // User Script
        this.addIncludeScript("SD6100F.xfdl","Lib::Lib_service.xjs");
        this.addIncludeScript("SD6100F.xfdl","Lib::Lib_etc.xjs");
        this.registerScript("SD6100F.xfdl", function() {
        ...
        this.SD6100F_onload = function(obj,e)
        {
        ...
        {
        	var strUrl = "JSP/sd/select_bdbr.jsp";
        	var strArg;
        	var strDs 	= "ds_bdbr=ds_bdbr";
        ...
        {
        	this.ds_bdbr.setColumn(NewRowNum,"CODE", nexacro.trim(this.ed_code.value));
        	this.ds_bdbr.setColumn(NewRowNum,"NAME", this.ed_name.text);
            this.ds_bdbr_send.addRow();
        	this.ds_bdbr_send.copyRow(0,this.ds_bdbr,NewRowNum);
        	this.ds_bdbr_send.setColumn(0,"O_CODE", o_code);
        	this.ds_bdbr_send.setColumn(0,"ROWTYPE", "I" );
        }

        //수정모드
        this.fnEdit_data = function()
        {
        	this.ds_bdbr.setColumn(EditnRow,"CODE", nexacro.trim(this.ed_code.value));
        	this.ds_bdbr.setColumn(EditnRow,"NAME", this.ed_name.text);
            this.ds_bdbr_send.addRow();
        	this.ds_bdbr_send.copyRow(0,this.ds_bdbr,EditnRow);
        	this.ds_bdbr_send.setColumn(0,"O_CODE", o_code);
        	this.ds_bdbr_send.setColumn(0,"ROWTYPE", "U" );
        ...
        this.grd_view_oncelldblclick = function(obj,e)
        {
            IUSW            =  "Y";
        	EditnRow = e.row;
        	this.ed_code.set_value(this.ds_bdbr.getColumn(e.row,"CODE"));
        	o_code       = this.ds_bdbr.getColumn(e.row,"CODE");
        	this.ed_name.set_value(this.ds_bdbr.getColumn(e.row,"NAME"));
        };

        this.btn_save_onclick = function(obj,e)
        {
        	var strUrl = "JSP/sd/insert_bdbr.jsp";
        	var inDs 	= "ds_bdbr_send=ds_bdbr_send";
        	if ((nexacro.trim(this.ed_code.value)).length != 1)
        	{
        		alert("코드 오류! 수정하세요!");
        		return;
        	}
        ...
        this.fnTr_Callback = function(strSvcID, nErrorCode, strErrorMag)
        {
        	...
        	if ( strSvcID == "delete" )
        	{
        		...
        		{
        			this.ds_bdbr.deleteRow(EditnRow);
                 	this.fnDataclear();
                	this.ed_code.setFocus();
        		}
        	}
        ...
        this.btn_del_onclick = function(obj,e)
        {
        	...
        	if(msg_result = objApp.confirm( "삭제된 데이터는 복원하실수 없습니다.\n 정말 삭제하시겠습니까? " , "삭제처리", "warning" ))
            {
        		...
        		this.ds_bdbr_send.copyRow(0,this.ds_bdbr,EditnRow);
        		this.ds_bdbr_send.setColumn(0,"O_CODE", o_code);
        		this.ds_bdbr_send.setColumn(0,"ROWTYPE", "D" );
        		//alert(o_code);
        ...
        this.ds_bdbr_onload = function(obj,e)
        {
        	if(e.reason == 0)
        	{
        		if (this.ds_bdbr.rowcount == 0)
        			alert("조회된 데이터가 없습니다.");
        	}
        };
        ...
        {
            this.addEventHandler("onload",this.SD6100F_onload,this);
        ...
        this.loadIncludeScript("SD6100F.xfdl");
