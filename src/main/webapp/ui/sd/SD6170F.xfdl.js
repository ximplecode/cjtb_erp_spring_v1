(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Dataset("ds_kwa_send", this);
        ...
        // User Script
        this.addIncludeScript("SD6170F.xfdl","Lib::Lib_service.xjs");
        this.addIncludeScript("SD6170F.xfdl","Lib::Lib_etc.xjs");
        this.registerScript("SD6170F.xfdl", function() {
        ...
        {
        	var strUrl = "JSP/sd/select_kwa.jsp";
        	var strArg;
        	var strDs 	= "ds_kwa=ds_kwa";
        ...
        {
        	this.ds_kwa.setColumn(NewRowNum,"CODE", nexacro.trim(this.ed_code.value));
        	this.ds_kwa.setColumn(NewRowNum,"NAME", this.ed_name.text);
            this.ds_kwa_send.addRow();
        	this.ds_kwa_send.copyRow(0,this.ds_kwa,NewRowNum);
        	this.ds_kwa_send.setColumn(0,"O_CODE", o_code);
        	this.ds_kwa_send.setColumn(0,"ROWTYPE", "I" );
        }

        //수정모드
        this.fnEdit_data = function()
        {
        	this.ds_kwa.setColumn(EditnRow,"CODE", nexacro.trim(this.ed_code.value));
        	this.ds_kwa.setColumn(EditnRow,"NAME", this.ed_name.text);
            this.ds_kwa_send.addRow();
        	this.ds_kwa_send.copyRow(0,this.ds_kwa,EditnRow);
        	this.ds_kwa_send.setColumn(0,"O_CODE", o_code);
        	this.ds_kwa_send.setColumn(0,"ROWTYPE", "U" );
        ...
        {
        	EditnRow = e.row;
        	this.ed_code.set_value(this.ds_kwa.getColumn(e.row,"CODE"));
        	o_code       = this.ds_kwa.getColumn(e.row,"CODE");
        	this.ed_name.set_value(this.ds_kwa.getColumn(e.row,"NAME"));
        };

        this.btn_save_onclick = function(obj,e)
        {
        	var strUrl = "JSP/sd/insert_kwa.jsp";
        	var inDs 	= "ds_kwa_send=ds_kwa_send";
        ...
        this.fnTr_Callback = function(strSvcID, nErrorCode, strErrorMag)
        {
        	...
        	if ( strSvcID == "delete" )
        	{
        		...
        		{
        			this.ds_kwa.deleteRow(EditnRow);
                 	this.fnDataclear();
                	this.ed_code.setFocus();
        		}
        	}
        ...
        this.btn_del_onclick = function(obj,e)
        {
        	...
        	if(msg_result = objApp.confirm( "삭제된 데이터는 복원하실수 없습니다.\n 정말 삭제하시겠습니까? " , "삭제처리", "warning" ))
            {
        		...
        		this.ds_kwa_send.copyRow(0,this.ds_kwa,EditnRow);
        		this.ds_kwa_send.setColumn(0,"O_CODE", o_code);
        		this.ds_kwa_send.setColumn(0,"ROWTYPE", "D" );
        		//alert(o_code);
        ...
        this.ds_kwa_onload = function(obj,e)
        {
        	if(e.reason == 0)
        	{
        		if (this.ds_kwa.rowcount == 0)
        			alert("조회된 데이터가 없습니다.");
        	}
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.ds_kwa.addEventHandler("onload",this.ds_kwa_onload,this);
        };
        this.loadIncludeScript("SD6170F.xfdl");
