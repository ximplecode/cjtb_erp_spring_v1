...
<%
  ...
  String sabun         = inVl.getString("sabun");
  String sql;
  
  
  System.out.println("pSABUN => " + sabun);
  
	try {
	  
	  Callstmt = conn.prepareCall("{Call GROUPWARE.PKG_I_FLOW.PROC_FLOW_COUNT_SELECT(?,?)}");
	  Callstmt.registerOutParameter(1, TbTypes.CURSOR);
	  Callstmt.setString(2, sabun);
