...
<head>
  ...
  <title>천재교과서 ERP 신규 Launcher</title> 
  <style>
  div.container {
    position: relative;
...
.warnnig_small {
  ...
  <script type="text/javascript" src="http://cjtb-erp.chunjae.co.kr/common/newlauncher_new1.js" charset="UTF-8"></script>
</head>
<body>
<div id="container" class="container">
<div id="contents">
	<div id="logo">
		<img src="http://cjtb-erp.chunjae.co.kr/common/install/etc_files/cjtb_logo.png" alt="천재교과서">
	</div>
	<p></p>
	<p></p>
	<p></p>
  ...
  <div id="installFile">
    <div id="launcher">
     ...
     <a id="linklaucher"  class="button" href="http://cjtb-erp.chunjae.co.kr/common/install/TPLSvc_Setup.exe">런처 설치</a>
	 <a id="rdocx50u_pro" class="button" href="http://cjtb-erp.chunjae.co.kr/common/install/rdocx50u_pro.exe">레포팅툴 설치</a>
