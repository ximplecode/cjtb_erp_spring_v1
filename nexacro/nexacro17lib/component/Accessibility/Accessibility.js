...
nexacro._setEnableAccessibility = function (v) {
	...
	if (v && nexacro._Browser != "Runtime" && app) {
		var frame = app.mainframe;
		if (frame && frame._waitcomp && frame._waitcomp._img_elem && frame._waitcomp._img_elem.handle) {
			nexacro.__setDOMNode_Alt(frame._waitcomp._img_elem.handle, "Wait Cursor");
		}
	}
